...
/* structure containing all private parameters of thorn WaveToyF90 */
struct
{
  int dummy_parameter;
} PRIVATE_WAVETOYF90_STRUCT;


/* structure containing all restricted parameters of thorn WaveToyF90 */
struct
{
  const char * bound;
...
int CCTKi_BindingsCreateWaveToyF90Parameters(void);
int CCTKi_BindingsCreateWaveToyF90Parameters(void)
{
...
int CCTKi_BindingsWaveToyF90ParameterExtensions(void);
int CCTKi_BindingsWaveToyF90ParameterExtensions(void)
{
  return 0;
}
