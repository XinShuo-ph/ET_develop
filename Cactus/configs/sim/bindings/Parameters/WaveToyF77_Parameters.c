...
/* structure containing all private parameters of thorn WaveToyF77 */
struct
{
  int dummy_parameter;
} PRIVATE_WAVETOYF77_STRUCT;


/* structure containing all restricted parameters of thorn WaveToyF77 */
struct
{
  const char * bound;
...
int CCTKi_BindingsCreateWaveToyF77Parameters(void);
int CCTKi_BindingsCreateWaveToyF77Parameters(void)
{
...
int CCTKi_BindingsWaveToyF77ParameterExtensions(void);
int CCTKi_BindingsWaveToyF77ParameterExtensions(void)
{
  return 0;
}
