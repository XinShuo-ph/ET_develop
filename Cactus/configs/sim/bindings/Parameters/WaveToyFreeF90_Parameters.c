/*@@
   @file    WaveToyFreeF90_Parameters.c
...
/* structure containing all private parameters of thorn WaveToyFreeF90 */
struct
{
  int dummy_parameter;
} PRIVATE_WAVETOYFREEF90_STRUCT;


/* structure containing all restricted parameters of thorn WaveToyFreeF90 */
struct
{
  const char * bound;
...
int CCTKi_BindingsCreateWaveToyFreeF90Parameters(void);
int CCTKi_BindingsCreateWaveToyFreeF90Parameters(void)
{
...
int CCTKi_BindingsWaveToyFreeF90ParameterExtensions(void);
int CCTKi_BindingsWaveToyFreeF90ParameterExtensions(void)
{
  return 0;
}
