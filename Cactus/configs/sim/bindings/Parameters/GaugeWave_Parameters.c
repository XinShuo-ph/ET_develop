...
int CCTKi_BindingsCreateGaugeWaveParameters(void)
{
  ...
  CCTKi_ParameterCreate("GaugeWave_exact_calc_every",
                        "GaugeWave",
                        "INT",
                        "RESTRICTED",
                        CCTK_STEERABLE_ALWAYS,
                        "GaugeWave_exact_calc_every",
                        "1",
                        &(RESTRICTED_GAUGEWAVE_STRUCT.GaugeWave_exact_calc_every),
                        0,
                        NULL,
                        1,
                        "*:*", "");

  CCTKi_ParameterCreate("GaugeWave_exact_calc_offset",
                        "GaugeWave",
                        "INT",
                        "RESTRICTED",
                        CCTK_STEERABLE_ALWAYS,
                        "GaugeWave_exact_calc_offset",
                        "0",
                        &(RESTRICTED_GAUGEWAVE_STRUCT.GaugeWave_exact_calc_offset),
                        0,
                        NULL,
                        1,
                        "*:*", "");
  ...
  CCTKi_ParameterCreate("tile_size",
                        ...
                        "Loop tile size",
                        "-1",
                        &(RESTRICTED_GAUGEWAVE_STRUCT.tile_size),
                        0,
                        NULL,
                        1,
                        "*:*", "");
  ...
  CCTKi_ParameterCreate("exact_method",
                        ...
                        "exact_method",
                        "none",
                        &(PRIVATE_GAUGEWAVE_STRUCT.exact_method),
                        0,
                        NULL,
                        2,
                        "none", "",
