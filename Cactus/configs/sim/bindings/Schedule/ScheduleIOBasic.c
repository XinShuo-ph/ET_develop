...
void CCTKi_BindingsSchedule_IOBasic(void)
{
  ...
  if(!(1 >= 0 && 1  <= CCTK_DeclaredTimeLevels("IOBasic::next_info_output_time")))
      CCTK_VWarn(0, __LINE__, __FILE__, CCTK_THORNSTRING,
                 "Tried to schedule %ld timelevels for group '%s' in schedule.ccl.\n"
                 "Value must be between 0 and %d (inclusive)",
                 (long)1, "IOBasic::next_info_output_time", CCTK_DeclaredTimeLevels("IOBasic::next_info_output_time"));
  if(!(1 >= 0 && 1  <= CCTK_DeclaredTimeLevels("IOBasic::next_scalar_output_time")))
      CCTK_VWarn(0, __LINE__, __FILE__, CCTK_THORNSTRING,
                 "Tried to schedule %ld timelevels for group '%s' in schedule.ccl.\n"
                 "Value must be between 0 and %d (inclusive)",
                 (long)1, "IOBasic::next_scalar_output_time", CCTK_DeclaredTimeLevels("IOBasic::next_scalar_output_time"));
