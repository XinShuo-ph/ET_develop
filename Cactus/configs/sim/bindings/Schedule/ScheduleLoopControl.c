...
#include "LoopControl/cctk.h"
#include "LoopControl/CParameters.h"
#include "cctki_ScheduleBindings.h"
#include "LoopControl/cctk_ScheduleFunctions.h"
...
void CCTKi_BindingsSchedule_LoopControl(void)
{
  DECLARE_CCTK_PARAMETERS
  {
    ...
    CCTKi_ScheduleFunction((void *)lc_setup,
                           "lc_setup",
                           "LoopControl",
                           "LoopControl",
                           "Set up LoopControl",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)lc_steer,
                           "lc_steer",
                           "LoopControl",
                           "LoopControl",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)lc_statistics_analysis,
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)lc_statistics_terminate,
