...
void CCTKi_BindingsSchedule_CartGrid3D(void)
{
  ...
  if(!(1 >= 0 && 1  <= CCTK_DeclaredTimeLevels("grid::coordinates")))
      CCTK_VWarn(0, __LINE__, __FILE__, CCTK_THORNSTRING,
                 "Tried to schedule %ld timelevels for group '%s' in schedule.ccl.\n"
                 "Value must be between 0 and %d (inclusive)",
                 (long)1, "grid::coordinates", CCTK_DeclaredTimeLevels("grid::coordinates"));
  if(!(1 >= 0 && 1  <= CCTK_DeclaredTimeLevels("grid::gridspacings")))
      CCTK_VWarn(0, __LINE__, __FILE__, CCTK_THORNSTRING,
                 "Tried to schedule %ld timelevels for group '%s' in schedule.ccl.\n"
                 "Value must be between 0 and %d (inclusive)",
                 (long)1, "grid::gridspacings", CCTK_DeclaredTimeLevels("grid::gridspacings"));
