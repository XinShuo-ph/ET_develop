...
#include "Cartoon2D/cctk.h"
#include "Cartoon2D/CParameters.h"
#include "cctki_ScheduleBindings.h"
#include "Cartoon2D/cctk_ScheduleFunctions.h"
...
if (cartoon_active)
{
  if(!(1 >= 0 && 1  <= CCTK_DeclaredTimeLevels("Cartoon2D::excision_variables")))
      CCTK_VWarn(0, __LINE__, __FILE__, CCTK_THORNSTRING,
                 "Tried to schedule %ld timelevels for group '%s' in schedule.ccl.\n"
                 "Value must be between 0 and %d (inclusive)",
                 (long)1, "Cartoon2D::excision_variables", CCTK_DeclaredTimeLevels("Cartoon2D::excision_variables"));
