...
#include "FleshInfo/CParameters.h"
...
void CCTKi_BindingsSchedule_FleshInfo(void)
{
  DECLARE_CCTK_PARAMETERS
  {
    ...
    CCTKi_ScheduleFunction((void *)InterpInfo,
                           "InterpInfo",
                           "FleshInfo",
                           "FleshInfo",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)ReduceInfo,
                           "ReduceInfo",
                           "FleshInfo",
                           "FleshInfo",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)IOInfo,
                           "IOInfo",
                           "FleshInfo",
                           "FleshInfo",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CoordInfo,
                           "CoordInfo",
                           "FleshInfo",
                           "FleshInfo",
...
/*@@
  @routine    CCTKi_BindingsParameterRecovery_FleshInfo
  @author     Automatically generated by CreateScheduleBindings.pl
  @desc
              Creates the parameter recovery bindings for thorn FleshInfo
  @enddesc
@@*/
