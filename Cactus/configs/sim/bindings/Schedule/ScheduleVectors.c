...
void CCTKi_BindingsSchedule_Vectors(void)
{
  DECLARE_CCTK_PARAMETERS
  {
    ...
    CCTKi_ScheduleFunction((void *)Vectors_Startup,
                           "Vectors_Startup",
                           "Vectors",
                           "Vectors",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)Vectors_Test,
                           "Vectors_Test",
                           "Vectors",
                           "Vectors",
...
/*@@
  @routine    CCTKi_BindingsParameterRecovery_Vectors
  @author     Automatically generated by CreateScheduleBindings.pl
  @desc
              Creates the parameter recovery bindings for thorn Vectors
  @enddesc
@@*/
