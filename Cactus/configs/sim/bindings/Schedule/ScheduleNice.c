...
void CCTKi_BindingsSchedule_Nice(void)
{
  DECLARE_CCTK_PARAMETERS
  {
    ...
    CCTKi_ScheduleFunction((void *)Nice_Renice,
                           "Nice_Renice",
                           "Nice",
                           "nice",
                           "Renice the process",
...
/*@@
  @routine    CCTKi_BindingsParameterRecovery_Nice
  @author     Automatically generated by CreateScheduleBindings.pl
  @desc
              Creates the parameter recovery bindings for thorn Nice
  @enddesc
@@*/
