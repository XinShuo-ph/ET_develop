...
void CCTKi_BindingsSchedule_Time(void)
{
  ...
  if(!(1 >= 0 && 1  <= CCTK_DeclaredTimeLevels("time::speedvars")))
      CCTK_VWarn(0, __LINE__, __FILE__, CCTK_THORNSTRING,
                 "Tried to schedule %ld timelevels for group '%s' in schedule.ccl.\n"
                 "Value must be between 0 and %d (inclusive)",
                 (long)1, "time::speedvars", CCTK_DeclaredTimeLevels("time::speedvars"));
  if(!(1 >= 0 && 1  <= CCTK_DeclaredTimeLevels("Time::couranttemps")))
      CCTK_VWarn(0, __LINE__, __FILE__, CCTK_THORNSTRING,
                 "Tried to schedule %ld timelevels for group '%s' in schedule.ccl.\n"
                 "Value must be between 0 and %d (inclusive)",
                 (long)1, "Time::couranttemps", CCTK_DeclaredTimeLevels("Time::couranttemps"));
