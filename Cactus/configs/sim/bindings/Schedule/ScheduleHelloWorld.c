...
void CCTKi_BindingsSchedule_HelloWorld(void)
{
  DECLARE_CCTK_PARAMETERS
  {
    ...
    CCTKi_ScheduleFunction((void *)HelloWorld,
                           "HelloWorld",
                           "HelloWorld",
                           "helloworld",
...
/*@@
  @routine    CCTKi_BindingsParameterRecovery_HelloWorld
  @author     Automatically generated by CreateScheduleBindings.pl
  @desc
              Creates the parameter recovery bindings for thorn HelloWorld
  @enddesc
@@*/
