...
void CCTKi_BindingsSchedule_TestFortranCrayPointers(void)
{
  DECLARE_CCTK_PARAMETERS
  {
    ...
    CCTKi_ScheduleFunction((void *)TestFortranCrayPointers_main,
...
/*@@
  @routine    CCTKi_BindingsParameterRecovery_TestFortranCrayPointers
  @author     Automatically generated by CreateScheduleBindings.pl
  @desc
              Creates the parameter recovery bindings for thorn TestFortranCrayPointers
  @enddesc
@@*/
