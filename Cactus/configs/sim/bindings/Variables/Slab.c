/*@@
   ...
   @desc
            Creates the CCTK variables for thorn Slab
   @enddesc
 @@*/
...
static int CCTKi_BindingsFortranWrapperSlab(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperSlab(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(SLAB_C2F_PROTO);
  DECLARE_SLAB_C2F
  INITIALISE_SLAB_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (SLAB_C2F_PROTO)) fpointer;
  function (PASS_SLAB_C2F (GH));
...
int CactusBindingsVariables_Slab_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("Slab", CCTKi_BindingsFortranWrapperSlab);
