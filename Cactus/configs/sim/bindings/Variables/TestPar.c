/*@@
   ...
   @desc
            Creates the CCTK variables for thorn TestPar
   @enddesc
 @@*/
...
static int CCTKi_BindingsFortranWrapperTestPar(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperTestPar(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(TESTPAR_C2F_PROTO);
  DECLARE_TESTPAR_C2F
  INITIALISE_TESTPAR_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (TESTPAR_C2F_PROTO)) fpointer;
  function (PASS_TESTPAR_C2F (GH));
...
int CactusBindingsVariables_TestPar_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("TestPar", CCTKi_BindingsFortranWrapperTestPar);
