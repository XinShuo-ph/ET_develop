/*@@
   ...
   @desc
            Creates the CCTK variables for thorn Socket
   @enddesc
 @@*/
...
static int CCTKi_BindingsFortranWrapperSocket(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperSocket(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(SOCKET_C2F_PROTO);
  DECLARE_SOCKET_C2F
  INITIALISE_SOCKET_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (SOCKET_C2F_PROTO)) fpointer;
  function (PASS_SOCKET_C2F (GH));
...
int CactusBindingsVariables_Socket_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("Socket", CCTKi_BindingsFortranWrapperSocket);
