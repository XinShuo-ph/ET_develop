/*@@
   ...
   @desc
            Creates the CCTK variables for thorn IOHDF5Util
   @enddesc
 @@*/
...
#include "IOHDF5Util/cctk.h"
#include "IOHDF5Util/cctk_Arguments.h"
#include "cctk_Parameter.h"
#include "cctk_WarnLevel.h"
#include "cctki_Groups.h"
#include "cctki_FortranWrappers.h"
#include "IOHDF5Util/cctk_ScheduleFunctions.h"

int CactusBindingsVariables_IOHDF5Util_Initialise(void);
static int CCTKi_BindingsFortranWrapperIOHDF5Util(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperIOHDF5Util(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(IOHDF5UTIL_C2F_PROTO);
  DECLARE_IOHDF5UTIL_C2F
  INITIALISE_IOHDF5UTIL_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (IOHDF5UTIL_C2F_PROTO)) fpointer;
  function (PASS_IOHDF5UTIL_C2F (GH));
...
int CactusBindingsVariables_IOHDF5Util_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("IOHDF5Util", CCTKi_BindingsFortranWrapperIOHDF5Util);
