/*@@
   ...
   @desc
            Creates the CCTK variables for thorn Vectors
   @enddesc
 @@*/
...
#include "Vectors/cctk.h"
#include "Vectors/cctk_Arguments.h"
#include "cctk_Parameter.h"
#include "cctk_WarnLevel.h"
#include "cctki_Groups.h"
#include "cctki_FortranWrappers.h"
#include "Vectors/cctk_ScheduleFunctions.h"

int CactusBindingsVariables_Vectors_Initialise(void);
static int CCTKi_BindingsFortranWrapperVectors(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperVectors(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(VECTORS_C2F_PROTO);
  DECLARE_VECTORS_C2F
  INITIALISE_VECTORS_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (VECTORS_C2F_PROTO)) fpointer;
  function (PASS_VECTORS_C2F (GH));
...
int CactusBindingsVariables_Vectors_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("Vectors", CCTKi_BindingsFortranWrapperVectors);
