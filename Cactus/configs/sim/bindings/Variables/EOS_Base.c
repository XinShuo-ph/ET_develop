/*@@
   ...
   @desc
            Creates the CCTK variables for thorn EOS_Base
   @enddesc
 @@*/
...
static int CCTKi_BindingsFortranWrapperEOS_Base(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperEOS_Base(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(EOS_BASE_C2F_PROTO);
  DECLARE_EOS_BASE_C2F
  INITIALISE_EOS_BASE_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (EOS_BASE_C2F_PROTO)) fpointer;
  function (PASS_EOS_BASE_C2F (GH));
...
int CactusBindingsVariables_EOS_Base_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("EOS_Base", CCTKi_BindingsFortranWrapperEOS_Base);
