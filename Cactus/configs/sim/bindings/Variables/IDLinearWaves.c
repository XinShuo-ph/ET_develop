/*@@
   @file    IDLinearWaves.c
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Creates the CCTK variables for thorn IDLinearWaves
   @enddesc
 @@*/
...
#include "IDLinearWaves/cctk_Arguments.h"
...
static int CCTKi_BindingsFortranWrapperIDLinearWaves(void *_GH, void *fpointer);
