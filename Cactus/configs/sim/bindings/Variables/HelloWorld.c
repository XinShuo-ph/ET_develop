/*@@
   ...
   @desc
            Creates the CCTK variables for thorn HelloWorld
   @enddesc
 @@*/
...
#include "HelloWorld/cctk.h"
#include "HelloWorld/cctk_Arguments.h"
#include "cctk_Parameter.h"
#include "cctk_WarnLevel.h"
#include "cctki_Groups.h"
#include "cctki_FortranWrappers.h"
#include "HelloWorld/cctk_ScheduleFunctions.h"

int CactusBindingsVariables_HelloWorld_Initialise(void);
static int CCTKi_BindingsFortranWrapperHelloWorld(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperHelloWorld(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(HELLOWORLD_C2F_PROTO);
  DECLARE_HELLOWORLD_C2F
  INITIALISE_HELLOWORLD_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (HELLOWORLD_C2F_PROTO)) fpointer;
  function (PASS_HELLOWORLD_C2F (GH));
...
int CactusBindingsVariables_HelloWorld_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("HelloWorld", CCTKi_BindingsFortranWrapperHelloWorld);
