/*@@
   ...
   @desc
            Creates the CCTK variables for thorn Timers
   @enddesc
 @@*/
...
#include "Timers/cctk.h"
#include "Timers/cctk_Arguments.h"
#include "cctk_Parameter.h"
#include "cctk_WarnLevel.h"
#include "cctki_Groups.h"
#include "cctki_FortranWrappers.h"
#include "Timers/cctk_ScheduleFunctions.h"

int CactusBindingsVariables_Timers_Initialise(void);
static int CCTKi_BindingsFortranWrapperTimers(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperTimers(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(TIMERS_C2F_PROTO);
  DECLARE_TIMERS_C2F
  INITIALISE_TIMERS_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (TIMERS_C2F_PROTO)) fpointer;
  function (PASS_TIMERS_C2F (GH));
...
int CactusBindingsVariables_Timers_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("Timers", CCTKi_BindingsFortranWrapperTimers);
