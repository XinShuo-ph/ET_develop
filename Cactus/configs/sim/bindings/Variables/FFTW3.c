/*@@
   ...
   @desc
            Creates the CCTK variables for thorn FFTW3
   @enddesc
 @@*/
...
#include "FFTW3/cctk_Arguments.h"
...
static int CCTKi_BindingsFortranWrapperFFTW3(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperFFTW3(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(FFTW3_C2F_PROTO);
  DECLARE_FFTW3_C2F
  INITIALISE_FFTW3_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (FFTW3_C2F_PROTO)) fpointer;
  function (PASS_FFTW3_C2F (GH));
...
int CactusBindingsVariables_FFTW3_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("FFTW3", CCTKi_BindingsFortranWrapperFFTW3);
