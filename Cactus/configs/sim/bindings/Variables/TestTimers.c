/*@@
   ...
   @desc
            Creates the CCTK variables for thorn TestTimers
   @enddesc
 @@*/
...
static int CCTKi_BindingsFortranWrapperTestTimers(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperTestTimers(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(TESTTIMERS_C2F_PROTO);
  DECLARE_TESTTIMERS_C2F
  INITIALISE_TESTTIMERS_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (TESTTIMERS_C2F_PROTO)) fpointer;
  function (PASS_TESTTIMERS_C2F (GH));
...
int CactusBindingsVariables_TestTimers_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("TestTimers", CCTKi_BindingsFortranWrapperTestTimers);
