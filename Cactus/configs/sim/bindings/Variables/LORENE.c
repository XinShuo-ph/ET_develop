/*@@
   ...
   @desc
            Creates the CCTK variables for thorn LORENE
   @enddesc
 @@*/
...
static int CCTKi_BindingsFortranWrapperLORENE(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperLORENE(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(LORENE_C2F_PROTO);
  DECLARE_LORENE_C2F
  INITIALISE_LORENE_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (LORENE_C2F_PROTO)) fpointer;
  function (PASS_LORENE_C2F (GH));
...
int CactusBindingsVariables_LORENE_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("LORENE", CCTKi_BindingsFortranWrapperLORENE);
