...
CCTK_DECLARE(CCTK_REAL,integrand,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,integrand_p,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,integrand_p_p,(cctk_ash1,cctk_ash2,cctk_ash3))&&\


#define CARPETINTEGRATETEST_PRIVATE_FARGUMENTS \
integrand,integrand_p,integrand_p_p

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_CARPETINTEGRATETEST_PRIVATE_CARGUMENTS \
static int cctki_vi_integrand = -100; \
if (cctki_vi_integrand == -100) cctki_vi_integrand = CCTK_VarIndex("CarpetIntegrateTest::integrand"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, integrand, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_integrand)); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, integrand_p, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 1, cctki_vi_integrand)); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, integrand_p_p, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 2, cctki_vi_integrand));
