...
#define CCTK_ARGUMENTS TRIGGER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TRIGGER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TRIGGER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TRIGGER_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TRIGGER_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TRIGGER_FARGUMENTS
#define CCTK_CARGUMENTS TRIGGER_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TRIGGER_CARGUMENTS
#endif
