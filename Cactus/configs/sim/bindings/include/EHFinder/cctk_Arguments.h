...
#define CCTK_ARGUMENTS EHFINDER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EHFINDER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS EHFINDER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EHFINDER_FARGUMENTS
#endif

#define CCTK_FARGUMENTS EHFINDER_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_EHFINDER_FARGUMENTS
#define CCTK_CARGUMENTS EHFINDER_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_EHFINDER_CARGUMENTS
#endif
