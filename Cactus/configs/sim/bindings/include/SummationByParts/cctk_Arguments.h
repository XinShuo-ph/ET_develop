...
#include "SummationByParts_Arguments.h"
...
#define CCTK_ARGUMENTS SUMMATIONBYPARTS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SUMMATIONBYPARTS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SUMMATIONBYPARTS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SUMMATIONBYPARTS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SUMMATIONBYPARTS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SUMMATIONBYPARTS_FARGUMENTS
#define CCTK_CARGUMENTS SUMMATIONBYPARTS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SUMMATIONBYPARTS_CARGUMENTS
#endif
