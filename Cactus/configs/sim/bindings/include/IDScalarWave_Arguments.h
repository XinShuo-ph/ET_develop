/*@@
   @header  IDScalarWave_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn IDScalarWave
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_IDSCALARWAVE_PRIVATE_FARGUMENTS \


#define IDSCALARWAVE_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDSCALARWAVE_PRIVATE_CARGUMENTS \


#define DECLARE_IDSCALARWAVE_PRIVATE_C2F \


#define INITIALISE_IDSCALARWAVE_PRIVATE_C2F \


#define IDSCALARWAVE_PRIVATE_C2F_PROTO \


#define PASS_IDSCALARWAVE_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_IDSCALARWAVE_PROTECTED_FARGUMENTS \


#define IDSCALARWAVE_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDSCALARWAVE_PROTECTED_CARGUMENTS \


#define DECLARE_IDSCALARWAVE_PROTECTED_C2F \


#define INITIALISE_IDSCALARWAVE_PROTECTED_C2F \


#define IDSCALARWAVE_PROTECTED_C2F_PROTO \


#define PASS_IDSCALARWAVE_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_IDSCALARWAVE_PUBLIC_FARGUMENTS \
...
#define IDSCALARWAVE_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,phi,phi_p,phi_p_p,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDSCALARWAVE_PUBLIC_CARGUMENTS \
...
#define DECLARE_IDSCALARWAVE_PUBLIC_C2F \
...
#define INITIALISE_IDSCALARWAVE_PUBLIC_C2F \
...
#ifdef FCODE
#define IDSCALARWAVE_FARGUMENTS _CCTK_FARGUMENTS, IDSCALARWAVE_PUBLIC_FARGUMENTS

#define DECLARE_IDSCALARWAVE_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_IDSCALARWAVE_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDSCALARWAVE_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_IDSCALARWAVE_PUBLIC_CARGUMENTS

#define IDSCALARWAVE_C2F_PROTO _CCTK_C2F_PROTO, IDSCALARWAVE_PUBLIC_C2F_PROTO

#define PASS_IDSCALARWAVE_C2F(GH) _PASS_CCTK_C2F(GH), PASS_IDSCALARWAVE_PUBLIC_C2F(GH)

#define DECLARE_IDSCALARWAVE_C2F _DECLARE_CCTK_C2F DECLARE_IDSCALARWAVE_PUBLIC_C2F

#define INITIALISE_IDSCALARWAVE_C2F _INITIALISE_CCTK_C2F INITIALISE_IDSCALARWAVE_PUBLIC_C2F

#define IDSCALARWAVE_CARGUMENTS cGH *cctkGH
