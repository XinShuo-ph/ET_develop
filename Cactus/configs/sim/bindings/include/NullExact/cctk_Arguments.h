...
#define CCTK_ARGUMENTS NULLEXACT_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NULLEXACT_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NULLEXACT_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NULLEXACT_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NULLEXACT_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NULLEXACT_FARGUMENTS
#define CCTK_CARGUMENTS NULLEXACT_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NULLEXACT_CARGUMENTS
#endif
