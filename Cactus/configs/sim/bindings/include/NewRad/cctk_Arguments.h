...
#define CCTK_ARGUMENTS NEWRAD_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NEWRAD_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NEWRAD_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NEWRAD_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NEWRAD_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NEWRAD_FARGUMENTS
#define CCTK_CARGUMENTS NEWRAD_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NEWRAD_CARGUMENTS
#endif
