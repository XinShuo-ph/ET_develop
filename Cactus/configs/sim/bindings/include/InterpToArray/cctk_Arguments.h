...
#include "InterpToArray_Arguments.h"
...
#define CCTK_ARGUMENTS INTERPTOARRAY_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_INTERPTOARRAY_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS INTERPTOARRAY_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_INTERPTOARRAY_FARGUMENTS
#endif

#define CCTK_FARGUMENTS INTERPTOARRAY_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_INTERPTOARRAY_FARGUMENTS
#define CCTK_CARGUMENTS INTERPTOARRAY_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_INTERPTOARRAY_CARGUMENTS
#endif
