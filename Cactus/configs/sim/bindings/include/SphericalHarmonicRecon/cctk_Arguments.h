...
#include "SphericalHarmonicRecon_Arguments.h"
...
#define CCTK_ARGUMENTS SPHERICALHARMONICRECON_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SPHERICALHARMONICRECON_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SPHERICALHARMONICRECON_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SPHERICALHARMONICRECON_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SPHERICALHARMONICRECON_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SPHERICALHARMONICRECON_FARGUMENTS
#define CCTK_CARGUMENTS SPHERICALHARMONICRECON_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SPHERICALHARMONICRECON_CARGUMENTS
#endif
