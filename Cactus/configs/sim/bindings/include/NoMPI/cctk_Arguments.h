...
#define CCTK_ARGUMENTS NOMPI_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NOMPI_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NOMPI_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NOMPI_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NOMPI_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NOMPI_FARGUMENTS
#define CCTK_CARGUMENTS NOMPI_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NOMPI_CARGUMENTS
#endif
