...
#define CCTK_ARGUMENTS VECTORS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_VECTORS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS VECTORS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_VECTORS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS VECTORS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_VECTORS_FARGUMENTS
#define CCTK_CARGUMENTS VECTORS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_VECTORS_CARGUMENTS
#endif
