...
#define CCTK_ARGUMENTS SLABTEST_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SLABTEST_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SLABTEST_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SLABTEST_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SLABTEST_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SLABTEST_FARGUMENTS
#define CCTK_CARGUMENTS SLABTEST_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SLABTEST_CARGUMENTS
#endif
