...
CCTK_DECLARE(CCTK_REAL,E,)&&\
CCTK_DECLARE(CCTK_REAL,J1,)&&\
CCTK_DECLARE(CCTK_REAL,J2,)&&\
CCTK_DECLARE(CCTK_REAL,J3,)&&\
CCTK_DECLARE(CCTK_REAL,puncture_u,(cctk_ash1,cctk_ash2,cctk_ash3))&&\


#define TWOPUNCTURES_PRIVATE_FARGUMENTS \
E,J1,J2,J3,puncture_u

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_TWOPUNCTURES_PRIVATE_CARGUMENTS \
static int cctki_vi_E = -100; \
if (cctki_vi_E == -100) cctki_vi_E = CCTK_VarIndex("TwoPunctures::E"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, E, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_E)); \
static int cctki_vi_J1 = -100; \
if (cctki_vi_J1 == -100) cctki_vi_J1 = CCTK_VarIndex("TwoPunctures::J1"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, J1, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_J1)); \
static int cctki_vi_J2 = -100; \
if (cctki_vi_J2 == -100) cctki_vi_J2 = CCTK_VarIndex("TwoPunctures::J2"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, J2, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_J2)); \
static int cctki_vi_J3 = -100; \
if (cctki_vi_J3 == -100) cctki_vi_J3 = CCTK_VarIndex("TwoPunctures::J3"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, J3, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_J3)); \
static int cctki_vi_puncture_u = -100; \
if (cctki_vi_puncture_u == -100) cctki_vi_puncture_u = CCTK_VarIndex("TwoPunctures::puncture_u"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, puncture_u, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_puncture_u));

#define DECLARE_TWOPUNCTURES_PRIVATE_C2F \
static int CCTKARGNUM_E = -1; \
static int CCTKGROUPNUM_energy = -1; \
static int CCTKARGNUM_J1 = -1; \
static int CCTKGROUPNUM_angular_momentum = -1; \
static int CCTKARGNUM_J2 = -1; \
static int CCTKARGNUM_J3 = -1; \
static int CCTKARGNUM_puncture_u = -1; \
static int CCTKGROUPNUM_puncture_u = -1;

#define INITIALISE_TWOPUNCTURES_PRIVATE_C2F \
if(CCTKARGNUM_E == -1) CCTKARGNUM_E = CCTK_VarIndex("TwoPunctures::E"); \
if(CCTKGROUPNUM_energy == -1) CCTKGROUPNUM_energy = CCTK_GroupIndex("TwoPunctures::energy"); \
if(CCTKARGNUM_J1 == -1) CCTKARGNUM_J1 = CCTK_VarIndex("TwoPunctures::J1"); \
if(CCTKGROUPNUM_angular_momentum == -1) CCTKGROUPNUM_angular_momentum = CCTK_GroupIndex("TwoPunctures::angular_momentum"); \
if(CCTKARGNUM_J2 == -1) CCTKARGNUM_J2 = CCTK_VarIndex("TwoPunctures::J2"); \
if(CCTKARGNUM_J3 == -1) CCTKARGNUM_J3 = CCTK_VarIndex("TwoPunctures::J3"); \
if(CCTKARGNUM_puncture_u == -1) CCTKARGNUM_puncture_u = CCTK_VarIndex("TwoPunctures::puncture_u"); \
if(CCTKGROUPNUM_puncture_u == -1) CCTKGROUPNUM_puncture_u = CCTK_GroupIndex("TwoPunctures::puncture_u");
...
(CCTK_REAL *)(PASS_REFERENCE(E, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(J1, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(J2, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(J3, 0)),\
...
CCTK_DECLARE(CCTK_REAL,mm,)&&\
CCTK_DECLARE(CCTK_REAL,mm_adm,)&&\
CCTK_DECLARE(CCTK_REAL,mp,)&&\
CCTK_DECLARE(CCTK_REAL,mp_adm,)&&\
...
alp,alp_p,alp_p_p,betax,betax_p,betax_p_p,betay,betay_p,betay_p_p,betaz,betaz_p,betaz_p_p,coarse_dx,coarse_dy,coarse_dz,conformal_state,dtalp,dtalp_p,dtalp_p_p,dtbetax,dtbetax_p,dtbetax_p_p,dtbetay,dtbetay_p,dtbetay_p_p,dtbetaz,dtbetaz_p,dtbetaz_p_p,dtlapse_state,dtshift_state,gxx,gxx_p,gxx_p_p,gxy,gxy_p,gxy_p_p,gxz,gxz_p,gxz_p_p,gyy,gyy_p,gyy_p_p,gyz,gyz_p,gyz_p_p,gzz,gzz_p,gzz_p_p,kxx,kxx_p,kxx_p_p,kxy,kxy_p,kxy_p_p,kxz,kxz_p,kxz_p_p,kyy,kyy_p,kyy_p_p,kyz,kyz_p,kyz_p_p,kzz,kzz_p,kzz_p_p,mm,mm_adm,mp,mp_adm,psi,psix,psixx,psixy,psixz,psiy,psiyy,psiyz,psiz,psizz,r,shift_state,x,y,z
...
static int cctki_vi_mm = -100; \
if (cctki_vi_mm == -100) cctki_vi_mm = CCTK_VarIndex("TwoPunctures::mm"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, mm, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_mm)); \
static int cctki_vi_mm_adm = -100; \
if (cctki_vi_mm_adm == -100) cctki_vi_mm_adm = CCTK_VarIndex("TwoPunctures::mm_adm"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, mm_adm, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_mm_adm)); \
static int cctki_vi_mp = -100; \
if (cctki_vi_mp == -100) cctki_vi_mp = CCTK_VarIndex("TwoPunctures::mp"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, mp, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_mp)); \
static int cctki_vi_mp_adm = -100; \
if (cctki_vi_mp_adm == -100) cctki_vi_mp_adm = CCTK_VarIndex("TwoPunctures::mp_adm"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, mp_adm, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_mp_adm)); \
...
static int CCTKARGNUM_mm_adm = -1; \
static int CCTKGROUPNUM_puncture_adm_mass = -1; \
static int CCTKARGNUM_mp = -1; \
static int CCTKARGNUM_mp_adm = -1; \
...
if(CCTKARGNUM_mm == -1) CCTKARGNUM_mm = CCTK_VarIndex("TwoPunctures::mm"); \
if(CCTKGROUPNUM_bare_mass == -1) CCTKGROUPNUM_bare_mass = CCTK_GroupIndex("TwoPunctures::bare_mass"); \
if(CCTKARGNUM_mm_adm == -1) CCTKARGNUM_mm_adm = CCTK_VarIndex("TwoPunctures::mm_adm"); \
if(CCTKGROUPNUM_puncture_adm_mass == -1) CCTKGROUPNUM_puncture_adm_mass = CCTK_GroupIndex("TwoPunctures::puncture_adm_mass"); \
if(CCTKARGNUM_mp == -1) CCTKARGNUM_mp = CCTK_VarIndex("TwoPunctures::mp"); \
if(CCTKARGNUM_mp_adm == -1) CCTKARGNUM_mp_adm = CCTK_VarIndex("TwoPunctures::mp_adm"); \
...
CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *
...
(CCTK_REAL *)(PASS_REFERENCE(mm_adm, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(mp, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(mp_adm, 0)),\
...
#ifdef FCODE
#define TWOPUNCTURES_FARGUMENTS _CCTK_FARGUMENTS, TWOPUNCTURES_PRIVATE_FARGUMENTS, TWOPUNCTURES_PUBLIC_FARGUMENTS

#define DECLARE_TWOPUNCTURES_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_TWOPUNCTURES_PRIVATE_FARGUMENTS DECLARE_TWOPUNCTURES_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_TWOPUNCTURES_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_TWOPUNCTURES_PRIVATE_CARGUMENTS DECLARE_TWOPUNCTURES_PUBLIC_CARGUMENTS

#define TWOPUNCTURES_C2F_PROTO _CCTK_C2F_PROTO, TWOPUNCTURES_PRIVATE_C2F_PROTO, TWOPUNCTURES_PUBLIC_C2F_PROTO

#define PASS_TWOPUNCTURES_C2F(GH) _PASS_CCTK_C2F(GH), PASS_TWOPUNCTURES_PRIVATE_C2F(GH), PASS_TWOPUNCTURES_PUBLIC_C2F(GH)

#define DECLARE_TWOPUNCTURES_C2F _DECLARE_CCTK_C2F DECLARE_TWOPUNCTURES_PRIVATE_C2F DECLARE_TWOPUNCTURES_PUBLIC_C2F

#define INITIALISE_TWOPUNCTURES_C2F _INITIALISE_CCTK_C2F INITIALISE_TWOPUNCTURES_PRIVATE_C2F INITIALISE_TWOPUNCTURES_PUBLIC_C2F
