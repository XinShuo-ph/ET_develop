...
#include "Hydro_InitExcision_Arguments.h"
...
#define CCTK_ARGUMENTS HYDRO_INITEXCISION_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HYDRO_INITEXCISION_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS HYDRO_INITEXCISION_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HYDRO_INITEXCISION_FARGUMENTS
#endif

#define CCTK_FARGUMENTS HYDRO_INITEXCISION_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_HYDRO_INITEXCISION_FARGUMENTS
#define CCTK_CARGUMENTS HYDRO_INITEXCISION_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_HYDRO_INITEXCISION_CARGUMENTS
#endif
