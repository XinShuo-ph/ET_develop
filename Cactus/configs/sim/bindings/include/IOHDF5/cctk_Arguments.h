...
#define CCTK_ARGUMENTS IOHDF5_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IOHDF5_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS IOHDF5_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IOHDF5_FARGUMENTS
#endif

#define CCTK_FARGUMENTS IOHDF5_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_IOHDF5_FARGUMENTS
#define CCTK_CARGUMENTS IOHDF5_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_IOHDF5_CARGUMENTS
#endif
