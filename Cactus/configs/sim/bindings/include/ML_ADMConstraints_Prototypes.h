/*@@
   @header  ML_ADMConstraints_Prototypes.h
...
#ifndef _ML_ADMCONSTRAINTS_PROTOTYPES_H_
#define _ML_ADMCONSTRAINTS_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_ML_ADMCONSTRAINTS_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
