...
CCTK_DECLARE(CCTK_INT,Vaidya2_MaxNumArrayEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,Vaidya2_MaxNumEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,Vaidya2_always_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,Vaidya2_always_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,Vaidya2_exact_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,Vaidya2_exact_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,Vaidya2_initial_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,Vaidya2_initial_calc_offset,)&&\
...
COMMON /Vaidya2rest/M, boostx, boosty, boostz, dM, lapsefactor, phi, positionx, positiony, positionz, psi, shiftaddx, shiftaddy, shiftaddz, theta, timeoffset, Vaidya2_MaxNumArrayEvolvedVars, Vaidya2_MaxNumEvolvedVars, Vaidya2_always_calc_every, Vaidya2_always_calc_offset, Vaidya2_exact_calc_every, Vaidya2_exact_calc_offset, Vaidya2_initial_calc_every, Vaidya2_initial_calc_offset, other_timelevels, rhs_timelevels, tile_size, timelevels, verbose&&\
CCTK_DECLARE(CCTK_STRING,exact_method,)&&\
COMMON /Vaidya2priv/exact_method&&\
