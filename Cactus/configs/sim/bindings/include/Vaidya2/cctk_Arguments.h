...
#define CCTK_ARGUMENTS VAIDYA2_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_VAIDYA2_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS VAIDYA2_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_VAIDYA2_FARGUMENTS
#endif

#define CCTK_FARGUMENTS VAIDYA2_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_VAIDYA2_FARGUMENTS
#define CCTK_CARGUMENTS VAIDYA2_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_VAIDYA2_CARGUMENTS
#endif
