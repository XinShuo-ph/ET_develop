...
#define CCTK_ARGUMENTS IDLINEARWAVES_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDLINEARWAVES_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS IDLINEARWAVES_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDLINEARWAVES_FARGUMENTS
#endif
