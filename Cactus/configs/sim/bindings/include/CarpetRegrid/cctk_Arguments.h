...
#define CCTK_ARGUMENTS CARPETREGRID_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETREGRID_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETREGRID_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETREGRID_FARGUMENTS
#endif
