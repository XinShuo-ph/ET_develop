...
#define CCTK_ARGUMENTS TESTMOL_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTMOL_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTMOL_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTMOL_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTMOL_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTMOL_FARGUMENTS
#define CCTK_CARGUMENTS TESTMOL_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTMOL_CARGUMENTS
#endif
