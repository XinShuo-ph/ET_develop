...
#define CCTK_ARGUMENTS SAMPLEIO_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SAMPLEIO_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SAMPLEIO_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SAMPLEIO_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SAMPLEIO_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SAMPLEIO_FARGUMENTS
#define CCTK_CARGUMENTS SAMPLEIO_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SAMPLEIO_CARGUMENTS
#endif
