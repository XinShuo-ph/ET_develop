...
#define CCTK_ARGUMENTS EXACT_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EXACT_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS EXACT_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EXACT_FARGUMENTS
#endif

#define CCTK_FARGUMENTS EXACT_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_EXACT_FARGUMENTS
#define CCTK_CARGUMENTS EXACT_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_EXACT_CARGUMENTS
#endif
