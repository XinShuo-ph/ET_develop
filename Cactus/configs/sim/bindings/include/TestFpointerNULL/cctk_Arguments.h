...
#include "TestFpointerNULL_Arguments.h"
...
#define CCTK_ARGUMENTS TESTFPOINTERNULL_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTFPOINTERNULL_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTFPOINTERNULL_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTFPOINTERNULL_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTFPOINTERNULL_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTFPOINTERNULL_FARGUMENTS
#define CCTK_CARGUMENTS TESTFPOINTERNULL_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTFPOINTERNULL_CARGUMENTS
#endif
