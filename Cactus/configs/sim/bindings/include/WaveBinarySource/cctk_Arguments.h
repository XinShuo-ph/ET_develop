...
#include "WaveBinarySource_Arguments.h"
...
#define CCTK_ARGUMENTS WAVEBINARYSOURCE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WAVEBINARYSOURCE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS WAVEBINARYSOURCE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WAVEBINARYSOURCE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS WAVEBINARYSOURCE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_WAVEBINARYSOURCE_FARGUMENTS
#define CCTK_CARGUMENTS WAVEBINARYSOURCE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_WAVEBINARYSOURCE_CARGUMENTS
#endif
