/*@@
   @header  Hydro_InitExcision_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn Hydro_InitExcision
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_HYDRO_INITEXCISION_PRIVATE_FARGUMENTS \


#define HYDRO_INITEXCISION_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_HYDRO_INITEXCISION_PRIVATE_CARGUMENTS \


#define DECLARE_HYDRO_INITEXCISION_PRIVATE_C2F \


#define INITIALISE_HYDRO_INITEXCISION_PRIVATE_C2F \


#define HYDRO_INITEXCISION_PRIVATE_C2F_PROTO \


#define PASS_HYDRO_INITEXCISION_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_HYDRO_INITEXCISION_PROTECTED_FARGUMENTS \


#define HYDRO_INITEXCISION_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_HYDRO_INITEXCISION_PROTECTED_CARGUMENTS \


#define DECLARE_HYDRO_INITEXCISION_PROTECTED_C2F \


#define INITIALISE_HYDRO_INITEXCISION_PROTECTED_C2F \


#define HYDRO_INITEXCISION_PROTECTED_C2F_PROTO \


#define PASS_HYDRO_INITEXCISION_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_HYDRO_INITEXCISION_PUBLIC_FARGUMENTS \
INTEGER Avec_length&&\
INTEGER Bvec_length&&\
INTEGER vel_length&&\
...
#define HYDRO_INITEXCISION_PUBLIC_FARGUMENTS \
Avec_length,Bvec_length,vel_length,Abar,Abar_p,Abar_p_p,Aphi,Aphi_p,Aphi_p_p,Avec,Avec_p,Avec_p_p,Bvec,Bvec_p,Bvec_p_p,Y_e,Y_e_p,Y_e_p_p,coarse_dx,coarse_dy,coarse_dz,emask,entropy,entropy_p,entropy_p_p,eps,eps_p,eps_p_p,hydro_excision_mask,press,press_p,press_p_p,r,rho,rho_p,rho_p_p,space_mask,temperature,temperature_p,temperature_p_p,vel,vel_p,vel_p_p,w_lorentz,w_lorentz_p,w_lorentz_p_p,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_HYDRO_INITEXCISION_PUBLIC_CARGUMENTS \
...
#define DECLARE_HYDRO_INITEXCISION_PUBLIC_C2F \
...
#define INITIALISE_HYDRO_INITEXCISION_PUBLIC_C2F \
...
#define HYDRO_INITEXCISION_PUBLIC_C2F_PROTO \
const int *,const int *,const int *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_HYDRO_INITEXCISION_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define HYDRO_INITEXCISION_FARGUMENTS _CCTK_FARGUMENTS, HYDRO_INITEXCISION_PUBLIC_FARGUMENTS

#define DECLARE_HYDRO_INITEXCISION_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_HYDRO_INITEXCISION_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_HYDRO_INITEXCISION_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_HYDRO_INITEXCISION_PUBLIC_CARGUMENTS

#define HYDRO_INITEXCISION_C2F_PROTO _CCTK_C2F_PROTO, HYDRO_INITEXCISION_PUBLIC_C2F_PROTO

#define PASS_HYDRO_INITEXCISION_C2F(GH) _PASS_CCTK_C2F(GH), PASS_HYDRO_INITEXCISION_PUBLIC_C2F(GH)

#define DECLARE_HYDRO_INITEXCISION_C2F _DECLARE_CCTK_C2F DECLARE_HYDRO_INITEXCISION_PUBLIC_C2F

#define INITIALISE_HYDRO_INITEXCISION_C2F _INITIALISE_CCTK_C2F INITIALISE_HYDRO_INITEXCISION_PUBLIC_C2F

#define HYDRO_INITEXCISION_CARGUMENTS cGH *cctkGH
