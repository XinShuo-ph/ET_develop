...
#define CCTK_ARGUMENTS POISSON_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_POISSON_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS POISSON_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_POISSON_FARGUMENTS
#endif

#define CCTK_FARGUMENTS POISSON_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_POISSON_FARGUMENTS
#define CCTK_CARGUMENTS POISSON_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_POISSON_CARGUMENTS
#endif
