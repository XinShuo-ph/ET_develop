...
CCTK_DECLARE(CCTK_INT,ML_ADMQuantities_MaxNumArrayEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,ML_ADMQuantities_MaxNumEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,ML_ADMQuantities_calculate_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_ADMQuantities_calculate_calc_offset,)&&\
...
COMMON /ML_ADMQuantitiesrest/ML_ADMQuantities_MaxNumArrayEvolvedVars, ML_ADMQuantities_MaxNumEvolvedVars, ML_ADMQuantities_calculate_calc_every, ML_ADMQuantities_calculate_calc_offset, conformalMethod, other_timelevels, rhs_timelevels, tile_size, timelevels, verbose&&\
