/*@@
   @header  IOHDF5Util_Prototypes.h
...
#ifndef _IOHDF5UTIL_PROTOTYPES_H_
#define _IOHDF5UTIL_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_IOHDF5UTIL_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
