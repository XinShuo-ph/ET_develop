...
#define CCTK_ARGUMENTS HYDROBASE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HYDROBASE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS HYDROBASE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HYDROBASE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS HYDROBASE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_HYDROBASE_FARGUMENTS
#define CCTK_CARGUMENTS HYDROBASE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_HYDROBASE_CARGUMENTS
#endif
