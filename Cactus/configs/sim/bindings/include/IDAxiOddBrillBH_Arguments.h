/*@@
   @header  IDAxiOddBrillBH_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn IDAxiOddBrillBH
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_IDAXIODDBRILLBH_PRIVATE_FARGUMENTS \
CCTK_DECLARE(CCTK_REAL,abseta,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,detaetapsi2d,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,detapsi2d,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,detaqpsi2d,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,dqpsi2d,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,dqqpsi2d,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,eta,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,phi,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,psi2d,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,q,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,sign_eta,(cctk_ash1,cctk_ash2,cctk_ash3))&&\


#define IDAXIODDBRILLBH_PRIVATE_FARGUMENTS \
abseta,detaetapsi2d,detapsi2d,detaqpsi2d,dqpsi2d,dqqpsi2d,eta,phi,psi2d,q,sign_eta

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDAXIODDBRILLBH_PRIVATE_CARGUMENTS \
static int cctki_vi_abseta = -100; \
if (cctki_vi_abseta == -100) cctki_vi_abseta = CCTK_VarIndex("IDAxiOddBrillBH::abseta"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, abseta, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_abseta)); \
static int cctki_vi_detaetapsi2d = -100; \
if (cctki_vi_detaetapsi2d == -100) cctki_vi_detaetapsi2d = CCTK_VarIndex("IDAxiOddBrillBH::detaetapsi2d"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, detaetapsi2d, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_detaetapsi2d)); \
static int cctki_vi_detapsi2d = -100; \
if (cctki_vi_detapsi2d == -100) cctki_vi_detapsi2d = CCTK_VarIndex("IDAxiOddBrillBH::detapsi2d"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, detapsi2d, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_detapsi2d)); \
static int cctki_vi_detaqpsi2d = -100; \
if (cctki_vi_detaqpsi2d == -100) cctki_vi_detaqpsi2d = CCTK_VarIndex("IDAxiOddBrillBH::detaqpsi2d"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, detaqpsi2d, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_detaqpsi2d)); \
static int cctki_vi_dqpsi2d = -100; \
if (cctki_vi_dqpsi2d == -100) cctki_vi_dqpsi2d = CCTK_VarIndex("IDAxiOddBrillBH::dqpsi2d"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, dqpsi2d, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_dqpsi2d)); \
static int cctki_vi_dqqpsi2d = -100; \
if (cctki_vi_dqqpsi2d == -100) cctki_vi_dqqpsi2d = CCTK_VarIndex("IDAxiOddBrillBH::dqqpsi2d"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, dqqpsi2d, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_dqqpsi2d)); \
static int cctki_vi_eta = -100; \
if (cctki_vi_eta == -100) cctki_vi_eta = CCTK_VarIndex("IDAxiOddBrillBH::eta"); \
...
if (cctki_vi_phi == -100) cctki_vi_phi = CCTK_VarIndex("IDAxiOddBrillBH::phi"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, phi, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_phi)); \
static int cctki_vi_psi2d = -100; \
if (cctki_vi_psi2d == -100) cctki_vi_psi2d = CCTK_VarIndex("IDAxiOddBrillBH::psi2d"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, psi2d, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_psi2d)); \
static int cctki_vi_q = -100; \
if (cctki_vi_q == -100) cctki_vi_q = CCTK_VarIndex("IDAxiOddBrillBH::q"); \
...
if (cctki_vi_sign_eta == -100) cctki_vi_sign_eta = CCTK_VarIndex("IDAxiOddBrillBH::sign_eta"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, sign_eta, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_sign_eta));

#define DECLARE_IDAXIODDBRILLBH_PRIVATE_C2F \
static int CCTKARGNUM_abseta = -1; \
static int CCTKGROUPNUM_sph_to_car_coord = -1; \
static int CCTKARGNUM_detaetapsi2d = -1; \
static int CCTKGROUPNUM_sph_to_car_psi = -1; \
static int CCTKARGNUM_detapsi2d = -1; \
static int CCTKARGNUM_detaqpsi2d = -1; \
static int CCTKARGNUM_dqpsi2d = -1; \
static int CCTKARGNUM_dqqpsi2d = -1; \
static int CCTKARGNUM_eta = -1; \
static int CCTKARGNUM_phi = -1; \
static int CCTKARGNUM_psi2d = -1; \
static int CCTKARGNUM_q = -1; \
static int CCTKARGNUM_sign_eta = -1;

#define INITIALISE_IDAXIODDBRILLBH_PRIVATE_C2F \
if(CCTKARGNUM_abseta == -1) CCTKARGNUM_abseta = CCTK_VarIndex("IDAxiOddBrillBH::abseta"); \
if(CCTKGROUPNUM_sph_to_car_coord == -1) CCTKGROUPNUM_sph_to_car_coord = CCTK_GroupIndex("IDAxiOddBrillBH::sph_to_car_coord"); \
if(CCTKARGNUM_detaetapsi2d == -1) CCTKARGNUM_detaetapsi2d = CCTK_VarIndex("IDAxiOddBrillBH::detaetapsi2d"); \
if(CCTKGROUPNUM_sph_to_car_psi == -1) CCTKGROUPNUM_sph_to_car_psi = CCTK_GroupIndex("IDAxiOddBrillBH::sph_to_car_psi"); \
if(CCTKARGNUM_detapsi2d == -1) CCTKARGNUM_detapsi2d = CCTK_VarIndex("IDAxiOddBrillBH::detapsi2d"); \
if(CCTKARGNUM_detaqpsi2d == -1) CCTKARGNUM_detaqpsi2d = CCTK_VarIndex("IDAxiOddBrillBH::detaqpsi2d"); \
if(CCTKARGNUM_dqpsi2d == -1) CCTKARGNUM_dqpsi2d = CCTK_VarIndex("IDAxiOddBrillBH::dqpsi2d"); \
if(CCTKARGNUM_dqqpsi2d == -1) CCTKARGNUM_dqqpsi2d = CCTK_VarIndex("IDAxiOddBrillBH::dqqpsi2d"); \
if(CCTKARGNUM_eta == -1) CCTKARGNUM_eta = CCTK_VarIndex("IDAxiOddBrillBH::eta"); \
if(CCTKARGNUM_phi == -1) CCTKARGNUM_phi = CCTK_VarIndex("IDAxiOddBrillBH::phi"); \
if(CCTKARGNUM_psi2d == -1) CCTKARGNUM_psi2d = CCTK_VarIndex("IDAxiOddBrillBH::psi2d"); \
if(CCTKARGNUM_q == -1) CCTKARGNUM_q = CCTK_VarIndex("IDAxiOddBrillBH::q"); \
if(CCTKARGNUM_sign_eta == -1) CCTKARGNUM_sign_eta = CCTK_VarIndex("IDAxiOddBrillBH::sign_eta");

#define IDAXIODDBRILLBH_PRIVATE_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_IDAXIODDBRILLBH_PRIVATE_C2F(GH) \
(CCTK_REAL *)(PASS_REFERENCE(abseta, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(detaetapsi2d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(detapsi2d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(detaqpsi2d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(dqpsi2d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(dqqpsi2d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(eta, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(phi, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(psi2d, 0)),\
...
#ifdef FCODE
#define DECLARE_IDAXIODDBRILLBH_PROTECTED_FARGUMENTS \


#define IDAXIODDBRILLBH_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDAXIODDBRILLBH_PROTECTED_CARGUMENTS \


#define DECLARE_IDAXIODDBRILLBH_PROTECTED_C2F \


#define INITIALISE_IDAXIODDBRILLBH_PROTECTED_C2F \


#define IDAXIODDBRILLBH_PROTECTED_C2F_PROTO \


#define PASS_IDAXIODDBRILLBH_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_IDAXIODDBRILLBH_PUBLIC_FARGUMENTS \
...
#define IDAXIODDBRILLBH_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_IDAXIODDBRILLBH_PUBLIC_CARGUMENTS \
...
#define DECLARE_IDAXIODDBRILLBH_PUBLIC_C2F \
...
#define INITIALISE_IDAXIODDBRILLBH_PUBLIC_C2F \
...
#define IDAXIODDBRILLBH_PUBLIC_C2F_PROTO \
...
#define PASS_IDAXIODDBRILLBH_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define IDAXIODDBRILLBH_FARGUMENTS _CCTK_FARGUMENTS, IDAXIODDBRILLBH_PRIVATE_FARGUMENTS, IDAXIODDBRILLBH_PUBLIC_FARGUMENTS

#define DECLARE_IDAXIODDBRILLBH_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_IDAXIODDBRILLBH_PRIVATE_FARGUMENTS DECLARE_IDAXIODDBRILLBH_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDAXIODDBRILLBH_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_IDAXIODDBRILLBH_PRIVATE_CARGUMENTS DECLARE_IDAXIODDBRILLBH_PUBLIC_CARGUMENTS

#define IDAXIODDBRILLBH_C2F_PROTO _CCTK_C2F_PROTO, IDAXIODDBRILLBH_PRIVATE_C2F_PROTO, IDAXIODDBRILLBH_PUBLIC_C2F_PROTO

#define PASS_IDAXIODDBRILLBH_C2F(GH) _PASS_CCTK_C2F(GH), PASS_IDAXIODDBRILLBH_PRIVATE_C2F(GH), PASS_IDAXIODDBRILLBH_PUBLIC_C2F(GH)

#define DECLARE_IDAXIODDBRILLBH_C2F _DECLARE_CCTK_C2F DECLARE_IDAXIODDBRILLBH_PRIVATE_C2F DECLARE_IDAXIODDBRILLBH_PUBLIC_C2F

#define INITIALISE_IDAXIODDBRILLBH_C2F _INITIALISE_CCTK_C2F INITIALISE_IDAXIODDBRILLBH_PRIVATE_C2F INITIALISE_IDAXIODDBRILLBH_PUBLIC_C2F

#define IDAXIODDBRILLBH_CARGUMENTS cGH *cctkGH
