...
#include "IDScalarWaveCXX_Arguments.h"
...
#define CCTK_ARGUMENTS IDSCALARWAVECXX_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDSCALARWAVECXX_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS IDSCALARWAVECXX_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDSCALARWAVECXX_FARGUMENTS
#endif

#define CCTK_FARGUMENTS IDSCALARWAVECXX_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_IDSCALARWAVECXX_FARGUMENTS
#define CCTK_CARGUMENTS IDSCALARWAVECXX_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_IDSCALARWAVECXX_CARGUMENTS
#endif
