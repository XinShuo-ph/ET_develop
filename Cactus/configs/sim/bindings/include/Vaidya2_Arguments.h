/*@@
   @header  Vaidya2_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn Vaidya2
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_VAIDYA2_PRIVATE_FARGUMENTS \


#define VAIDYA2_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_VAIDYA2_PRIVATE_CARGUMENTS \


#define DECLARE_VAIDYA2_PRIVATE_C2F \


#define INITIALISE_VAIDYA2_PRIVATE_C2F \


#define VAIDYA2_PRIVATE_C2F_PROTO \


#define PASS_VAIDYA2_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_VAIDYA2_PROTECTED_FARGUMENTS \


#define VAIDYA2_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_VAIDYA2_PROTECTED_CARGUMENTS \


#define DECLARE_VAIDYA2_PROTECTED_C2F \


#define INITIALISE_VAIDYA2_PROTECTED_C2F \


#define VAIDYA2_PROTECTED_C2F_PROTO \


#define PASS_VAIDYA2_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_VAIDYA2_PUBLIC_FARGUMENTS \
...
#define VAIDYA2_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_VAIDYA2_PUBLIC_CARGUMENTS \
...
if (cctki_vi_alpExact == -100) cctki_vi_alpExact = CCTK_VarIndex("Vaidya2::alpExact"); \
...
if (cctki_vi_betaExact1 == -100) cctki_vi_betaExact1 = CCTK_VarIndex("Vaidya2::betaExact1"); \
...
if (cctki_vi_betaExact2 == -100) cctki_vi_betaExact2 = CCTK_VarIndex("Vaidya2::betaExact2"); \
...
if (cctki_vi_betaExact3 == -100) cctki_vi_betaExact3 = CCTK_VarIndex("Vaidya2::betaExact3"); \
...
if (cctki_vi_dtalpExact == -100) cctki_vi_dtalpExact = CCTK_VarIndex("Vaidya2::dtalpExact"); \
...
if (cctki_vi_dtbetaExact1 == -100) cctki_vi_dtbetaExact1 = CCTK_VarIndex("Vaidya2::dtbetaExact1"); \
...
if (cctki_vi_dtbetaExact2 == -100) cctki_vi_dtbetaExact2 = CCTK_VarIndex("Vaidya2::dtbetaExact2"); \
...
if (cctki_vi_dtbetaExact3 == -100) cctki_vi_dtbetaExact3 = CCTK_VarIndex("Vaidya2::dtbetaExact3"); \
...
if (cctki_vi_gExact11 == -100) cctki_vi_gExact11 = CCTK_VarIndex("Vaidya2::gExact11"); \
...
if (cctki_vi_gExact12 == -100) cctki_vi_gExact12 = CCTK_VarIndex("Vaidya2::gExact12"); \
...
if (cctki_vi_gExact13 == -100) cctki_vi_gExact13 = CCTK_VarIndex("Vaidya2::gExact13"); \
...
if (cctki_vi_gExact22 == -100) cctki_vi_gExact22 = CCTK_VarIndex("Vaidya2::gExact22"); \
...
if (cctki_vi_gExact23 == -100) cctki_vi_gExact23 = CCTK_VarIndex("Vaidya2::gExact23"); \
...
if (cctki_vi_gExact33 == -100) cctki_vi_gExact33 = CCTK_VarIndex("Vaidya2::gExact33"); \
...
if (cctki_vi_kExact11 == -100) cctki_vi_kExact11 = CCTK_VarIndex("Vaidya2::kExact11"); \
...
if (cctki_vi_kExact12 == -100) cctki_vi_kExact12 = CCTK_VarIndex("Vaidya2::kExact12"); \
...
if (cctki_vi_kExact13 == -100) cctki_vi_kExact13 = CCTK_VarIndex("Vaidya2::kExact13"); \
...
if (cctki_vi_kExact22 == -100) cctki_vi_kExact22 = CCTK_VarIndex("Vaidya2::kExact22"); \
...
if (cctki_vi_kExact23 == -100) cctki_vi_kExact23 = CCTK_VarIndex("Vaidya2::kExact23"); \
...
if (cctki_vi_kExact33 == -100) cctki_vi_kExact33 = CCTK_VarIndex("Vaidya2::kExact33"); \
...
#define DECLARE_VAIDYA2_PUBLIC_C2F \
...
#define INITIALISE_VAIDYA2_PUBLIC_C2F \
...
if(CCTKARGNUM_alpExact == -1) CCTKARGNUM_alpExact = CCTK_VarIndex("Vaidya2::alpExact"); \
if(CCTKGROUPNUM_lapse_exact == -1) CCTKGROUPNUM_lapse_exact = CCTK_GroupIndex("Vaidya2::lapse_exact"); \
if(CCTKARGNUM_betaExact1 == -1) CCTKARGNUM_betaExact1 = CCTK_VarIndex("Vaidya2::betaExact1"); \
if(CCTKGROUPNUM_shift_exact == -1) CCTKGROUPNUM_shift_exact = CCTK_GroupIndex("Vaidya2::shift_exact"); \
if(CCTKARGNUM_betaExact2 == -1) CCTKARGNUM_betaExact2 = CCTK_VarIndex("Vaidya2::betaExact2"); \
if(CCTKARGNUM_betaExact3 == -1) CCTKARGNUM_betaExact3 = CCTK_VarIndex("Vaidya2::betaExact3"); \
...
if(CCTKARGNUM_dtalpExact == -1) CCTKARGNUM_dtalpExact = CCTK_VarIndex("Vaidya2::dtalpExact"); \
if(CCTKGROUPNUM_dtlapse_exact == -1) CCTKGROUPNUM_dtlapse_exact = CCTK_GroupIndex("Vaidya2::dtlapse_exact"); \
if(CCTKARGNUM_dtbetaExact1 == -1) CCTKARGNUM_dtbetaExact1 = CCTK_VarIndex("Vaidya2::dtbetaExact1"); \
if(CCTKGROUPNUM_dtshift_exact == -1) CCTKGROUPNUM_dtshift_exact = CCTK_GroupIndex("Vaidya2::dtshift_exact"); \
if(CCTKARGNUM_dtbetaExact2 == -1) CCTKARGNUM_dtbetaExact2 = CCTK_VarIndex("Vaidya2::dtbetaExact2"); \
if(CCTKARGNUM_dtbetaExact3 == -1) CCTKARGNUM_dtbetaExact3 = CCTK_VarIndex("Vaidya2::dtbetaExact3"); \
...
if(CCTKARGNUM_gExact11 == -1) CCTKARGNUM_gExact11 = CCTK_VarIndex("Vaidya2::gExact11"); \
if(CCTKGROUPNUM_metric_exact == -1) CCTKGROUPNUM_metric_exact = CCTK_GroupIndex("Vaidya2::metric_exact"); \
if(CCTKARGNUM_gExact12 == -1) CCTKARGNUM_gExact12 = CCTK_VarIndex("Vaidya2::gExact12"); \
if(CCTKARGNUM_gExact13 == -1) CCTKARGNUM_gExact13 = CCTK_VarIndex("Vaidya2::gExact13"); \
if(CCTKARGNUM_gExact22 == -1) CCTKARGNUM_gExact22 = CCTK_VarIndex("Vaidya2::gExact22"); \
if(CCTKARGNUM_gExact23 == -1) CCTKARGNUM_gExact23 = CCTK_VarIndex("Vaidya2::gExact23"); \
if(CCTKARGNUM_gExact33 == -1) CCTKARGNUM_gExact33 = CCTK_VarIndex("Vaidya2::gExact33"); \
...
if(CCTKARGNUM_kExact11 == -1) CCTKARGNUM_kExact11 = CCTK_VarIndex("Vaidya2::kExact11"); \
if(CCTKGROUPNUM_curv_exact == -1) CCTKGROUPNUM_curv_exact = CCTK_GroupIndex("Vaidya2::curv_exact"); \
if(CCTKARGNUM_kExact12 == -1) CCTKARGNUM_kExact12 = CCTK_VarIndex("Vaidya2::kExact12"); \
if(CCTKARGNUM_kExact13 == -1) CCTKARGNUM_kExact13 = CCTK_VarIndex("Vaidya2::kExact13"); \
if(CCTKARGNUM_kExact22 == -1) CCTKARGNUM_kExact22 = CCTK_VarIndex("Vaidya2::kExact22"); \
if(CCTKARGNUM_kExact23 == -1) CCTKARGNUM_kExact23 = CCTK_VarIndex("Vaidya2::kExact23"); \
if(CCTKARGNUM_kExact33 == -1) CCTKARGNUM_kExact33 = CCTK_VarIndex("Vaidya2::kExact33"); \
...
#define VAIDYA2_PUBLIC_C2F_PROTO \
...
#define PASS_VAIDYA2_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define VAIDYA2_FARGUMENTS _CCTK_FARGUMENTS, VAIDYA2_PUBLIC_FARGUMENTS

#define DECLARE_VAIDYA2_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_VAIDYA2_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_VAIDYA2_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_VAIDYA2_PUBLIC_CARGUMENTS

#define VAIDYA2_C2F_PROTO _CCTK_C2F_PROTO, VAIDYA2_PUBLIC_C2F_PROTO

#define PASS_VAIDYA2_C2F(GH) _PASS_CCTK_C2F(GH), PASS_VAIDYA2_PUBLIC_C2F(GH)

#define DECLARE_VAIDYA2_C2F _DECLARE_CCTK_C2F DECLARE_VAIDYA2_PUBLIC_C2F

#define INITIALISE_VAIDYA2_C2F _INITIALISE_CCTK_C2F INITIALISE_VAIDYA2_PUBLIC_C2F

#define VAIDYA2_CARGUMENTS cGH *cctkGH
