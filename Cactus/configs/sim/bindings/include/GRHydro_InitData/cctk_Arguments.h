...
#include "GRHydro_InitData_Arguments.h"
...
#define CCTK_ARGUMENTS GRHYDRO_INITDATA_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_GRHYDRO_INITDATA_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS GRHYDRO_INITDATA_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_GRHYDRO_INITDATA_FARGUMENTS
#endif

#define CCTK_FARGUMENTS GRHYDRO_INITDATA_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_GRHYDRO_INITDATA_FARGUMENTS
#define CCTK_CARGUMENTS GRHYDRO_INITDATA_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_GRHYDRO_INITDATA_CARGUMENTS
#endif
