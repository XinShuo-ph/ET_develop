/*@@
   @header  IDLinearWaves_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn IDLinearWaves
   @enddesc
 @@*/
...
#define PASS_IDLINEARWAVES_PRIVATE_C2F(GH) \
...
#define PASS_IDLINEARWAVES_PROTECTED_C2F(GH) \
...
#define PASS_IDLINEARWAVES_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define IDLINEARWAVES_FARGUMENTS _CCTK_FARGUMENTS, IDLINEARWAVES_PUBLIC_FARGUMENTS

#define DECLARE_IDLINEARWAVES_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_IDLINEARWAVES_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDLINEARWAVES_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_IDLINEARWAVES_PUBLIC_CARGUMENTS

#define IDLINEARWAVES_C2F_PROTO _CCTK_C2F_PROTO, IDLINEARWAVES_PUBLIC_C2F_PROTO

#define PASS_IDLINEARWAVES_C2F(GH) _PASS_CCTK_C2F(GH), PASS_IDLINEARWAVES_PUBLIC_C2F(GH)

#define DECLARE_IDLINEARWAVES_C2F _DECLARE_CCTK_C2F DECLARE_IDLINEARWAVES_PUBLIC_C2F

#define INITIALISE_IDLINEARWAVES_C2F _INITIALISE_CCTK_C2F INITIALISE_IDLINEARWAVES_PUBLIC_C2F
