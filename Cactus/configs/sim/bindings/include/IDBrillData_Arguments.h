/*@@
   @header  IDBrillData_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn IDBrillData
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_IDBRILLDATA_PRIVATE_FARGUMENTS \
CCTK_DECLARE(CCTK_REAL,brillMlinear,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,brillNsource,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,brillpsi,(cctk_ash1,cctk_ash2,cctk_ash3))&&\


#define IDBRILLDATA_PRIVATE_FARGUMENTS \
brillMlinear,brillNsource,brillpsi

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDBRILLDATA_PRIVATE_CARGUMENTS \
static int cctki_vi_brillMlinear = -100; \
if (cctki_vi_brillMlinear == -100) cctki_vi_brillMlinear = CCTK_VarIndex("IDBrillData::brillMlinear"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, brillMlinear, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_brillMlinear)); \
static int cctki_vi_brillNsource = -100; \
if (cctki_vi_brillNsource == -100) cctki_vi_brillNsource = CCTK_VarIndex("IDBrillData::brillNsource"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, brillNsource, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_brillNsource)); \
static int cctki_vi_brillpsi = -100; \
if (cctki_vi_brillpsi == -100) cctki_vi_brillpsi = CCTK_VarIndex("IDBrillData::brillpsi"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, brillpsi, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_brillpsi));

#define DECLARE_IDBRILLDATA_PRIVATE_C2F \
static int CCTKARGNUM_brillMlinear = -1; \
static int CCTKGROUPNUM_brillelliptic = -1; \
static int CCTKARGNUM_brillNsource = -1; \
static int CCTKARGNUM_brillpsi = -1; \
static int CCTKGROUPNUM_brillconf = -1;

#define INITIALISE_IDBRILLDATA_PRIVATE_C2F \
if(CCTKARGNUM_brillMlinear == -1) CCTKARGNUM_brillMlinear = CCTK_VarIndex("IDBrillData::brillMlinear"); \
if(CCTKGROUPNUM_brillelliptic == -1) CCTKGROUPNUM_brillelliptic = CCTK_GroupIndex("IDBrillData::brillelliptic"); \
if(CCTKARGNUM_brillNsource == -1) CCTKARGNUM_brillNsource = CCTK_VarIndex("IDBrillData::brillNsource"); \
if(CCTKARGNUM_brillpsi == -1) CCTKARGNUM_brillpsi = CCTK_VarIndex("IDBrillData::brillpsi"); \
if(CCTKGROUPNUM_brillconf == -1) CCTKGROUPNUM_brillconf = CCTK_GroupIndex("IDBrillData::brillconf");

#define IDBRILLDATA_PRIVATE_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_IDBRILLDATA_PRIVATE_C2F(GH) \
(CCTK_REAL *)(PASS_REFERENCE(brillMlinear, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(brillNsource, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(brillpsi, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_IDBRILLDATA_PROTECTED_FARGUMENTS \


#define IDBRILLDATA_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDBRILLDATA_PROTECTED_CARGUMENTS \


#define DECLARE_IDBRILLDATA_PROTECTED_C2F \


#define INITIALISE_IDBRILLDATA_PROTECTED_C2F \


#define IDBRILLDATA_PROTECTED_C2F_PROTO \


#define PASS_IDBRILLDATA_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_IDBRILLDATA_PUBLIC_FARGUMENTS \
...
#define IDBRILLDATA_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_IDBRILLDATA_PUBLIC_CARGUMENTS \
...
#define DECLARE_IDBRILLDATA_PUBLIC_C2F \
...
#define INITIALISE_IDBRILLDATA_PUBLIC_C2F \
...
#define IDBRILLDATA_PUBLIC_C2F_PROTO \
...
#define PASS_IDBRILLDATA_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define IDBRILLDATA_FARGUMENTS _CCTK_FARGUMENTS, IDBRILLDATA_PRIVATE_FARGUMENTS, IDBRILLDATA_PUBLIC_FARGUMENTS

#define DECLARE_IDBRILLDATA_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_IDBRILLDATA_PRIVATE_FARGUMENTS DECLARE_IDBRILLDATA_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDBRILLDATA_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_IDBRILLDATA_PRIVATE_CARGUMENTS DECLARE_IDBRILLDATA_PUBLIC_CARGUMENTS

#define IDBRILLDATA_C2F_PROTO _CCTK_C2F_PROTO, IDBRILLDATA_PRIVATE_C2F_PROTO, IDBRILLDATA_PUBLIC_C2F_PROTO

#define PASS_IDBRILLDATA_C2F(GH) _PASS_CCTK_C2F(GH), PASS_IDBRILLDATA_PRIVATE_C2F(GH), PASS_IDBRILLDATA_PUBLIC_C2F(GH)

#define DECLARE_IDBRILLDATA_C2F _DECLARE_CCTK_C2F DECLARE_IDBRILLDATA_PRIVATE_C2F DECLARE_IDBRILLDATA_PUBLIC_C2F

#define INITIALISE_IDBRILLDATA_C2F _INITIALISE_CCTK_C2F INITIALISE_IDBRILLDATA_PRIVATE_C2F INITIALISE_IDBRILLDATA_PUBLIC_C2F

#define IDBRILLDATA_CARGUMENTS cGH *cctkGH
