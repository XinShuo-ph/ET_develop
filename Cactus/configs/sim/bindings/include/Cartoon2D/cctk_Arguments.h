...
#define CCTK_ARGUMENTS CARTOON2D_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARTOON2D_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARTOON2D_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARTOON2D_FARGUMENTS
#endif
