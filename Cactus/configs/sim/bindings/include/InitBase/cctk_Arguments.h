...
#define CCTK_ARGUMENTS INITBASE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_INITBASE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS INITBASE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_INITBASE_FARGUMENTS
#endif
