/*@@
   @header  WaveToyExtra_Prototypes.h
...
#ifndef _WAVETOYEXTRA_PROTOTYPES_H_
#define _WAVETOYEXTRA_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_WAVETOYEXTRA_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
