...
COMMON /Cactuspriv/cctk_run_title, cctk_timer_output, info_format, recovery_mode, schedule_sort_mode, allow_mixeddim_gfs, cctk_brief_output, cctk_full_warnings, cctk_show_banners, cctk_show_schedule, cctk_strong_param_check, highlight_warning_messages, schedule_sort_warnings&&\
