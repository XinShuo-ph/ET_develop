...
#include "ML_WaveToy_Test_Arguments.h"
...
#define CCTK_ARGUMENTS ML_WAVETOY_TEST_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ML_WAVETOY_TEST_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ML_WAVETOY_TEST_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ML_WAVETOY_TEST_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ML_WAVETOY_TEST_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ML_WAVETOY_TEST_FARGUMENTS
#define CCTK_CARGUMENTS ML_WAVETOY_TEST_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ML_WAVETOY_TEST_CARGUMENTS
#endif
