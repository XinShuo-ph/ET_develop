...
#define CCTK_ARGUMENTS WAVEMOL_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WAVEMOL_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS WAVEMOL_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WAVEMOL_FARGUMENTS
#endif
