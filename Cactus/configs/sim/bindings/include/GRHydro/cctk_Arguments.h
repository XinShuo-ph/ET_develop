...
#define CCTK_ARGUMENTS GRHYDRO_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_GRHYDRO_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS GRHYDRO_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_GRHYDRO_FARGUMENTS
#endif

#define CCTK_FARGUMENTS GRHYDRO_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_GRHYDRO_FARGUMENTS
#define CCTK_CARGUMENTS GRHYDRO_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_GRHYDRO_CARGUMENTS
#endif
