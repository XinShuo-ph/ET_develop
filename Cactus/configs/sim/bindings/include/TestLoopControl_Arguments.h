/*@@
   @header  TestLoopControl_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn TestLoopControl
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_TESTLOOPCONTROL_PRIVATE_FARGUMENTS \
...
#define TESTLOOPCONTROL_PRIVATE_FARGUMENTS \
csum_all,csum_bnd,csum_int,csum_intbnd,fsum_all,fsum_bnd,fsum_int,fsum_intbnd,pointtypes

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_TESTLOOPCONTROL_PRIVATE_CARGUMENTS \
static int cctki_vi_csum_all = -100; \
if (cctki_vi_csum_all == -100) cctki_vi_csum_all = CCTK_VarIndex("TestLoopControl::csum_all"); \
...
if (cctki_vi_csum_bnd == -100) cctki_vi_csum_bnd = CCTK_VarIndex("TestLoopControl::csum_bnd"); \
...
if (cctki_vi_csum_int == -100) cctki_vi_csum_int = CCTK_VarIndex("TestLoopControl::csum_int"); \
...
if (cctki_vi_csum_intbnd == -100) cctki_vi_csum_intbnd = CCTK_VarIndex("TestLoopControl::csum_intbnd"); \
...
if (cctki_vi_fsum_all == -100) cctki_vi_fsum_all = CCTK_VarIndex("TestLoopControl::fsum_all"); \
...
if (cctki_vi_fsum_bnd == -100) cctki_vi_fsum_bnd = CCTK_VarIndex("TestLoopControl::fsum_bnd"); \
...
if (cctki_vi_fsum_int == -100) cctki_vi_fsum_int = CCTK_VarIndex("TestLoopControl::fsum_int"); \
...
if (cctki_vi_fsum_intbnd == -100) cctki_vi_fsum_intbnd = CCTK_VarIndex("TestLoopControl::fsum_intbnd"); \
...
if (cctki_vi_pointtypes == -100) cctki_vi_pointtypes = CCTK_VarIndex("TestLoopControl::pointtypes"); \
CCTK_DECLARE_INIT (CCTK_INT * restrict const, pointtypes, (CCTK_INT *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_pointtypes));

#define DECLARE_TESTLOOPCONTROL_PRIVATE_C2F \
...
#define INITIALISE_TESTLOOPCONTROL_PRIVATE_C2F \
if(CCTKARGNUM_csum_all == -1) CCTKARGNUM_csum_all = CCTK_VarIndex("TestLoopControl::csum_all"); \
if(CCTKGROUPNUM_csums == -1) CCTKGROUPNUM_csums = CCTK_GroupIndex("TestLoopControl::csums"); \
if(CCTKARGNUM_csum_bnd == -1) CCTKARGNUM_csum_bnd = CCTK_VarIndex("TestLoopControl::csum_bnd"); \
if(CCTKARGNUM_csum_int == -1) CCTKARGNUM_csum_int = CCTK_VarIndex("TestLoopControl::csum_int"); \
if(CCTKARGNUM_csum_intbnd == -1) CCTKARGNUM_csum_intbnd = CCTK_VarIndex("TestLoopControl::csum_intbnd"); \
if(CCTKARGNUM_fsum_all == -1) CCTKARGNUM_fsum_all = CCTK_VarIndex("TestLoopControl::fsum_all"); \
if(CCTKGROUPNUM_fsums == -1) CCTKGROUPNUM_fsums = CCTK_GroupIndex("TestLoopControl::fsums"); \
if(CCTKARGNUM_fsum_bnd == -1) CCTKARGNUM_fsum_bnd = CCTK_VarIndex("TestLoopControl::fsum_bnd"); \
if(CCTKARGNUM_fsum_int == -1) CCTKARGNUM_fsum_int = CCTK_VarIndex("TestLoopControl::fsum_int"); \
if(CCTKARGNUM_fsum_intbnd == -1) CCTKARGNUM_fsum_intbnd = CCTK_VarIndex("TestLoopControl::fsum_intbnd"); \
if(CCTKARGNUM_pointtypes == -1) CCTKARGNUM_pointtypes = CCTK_VarIndex("TestLoopControl::pointtypes"); \
if(CCTKGROUPNUM_pointtypes == -1) CCTKGROUPNUM_pointtypes = CCTK_GroupIndex("TestLoopControl::pointtypes");

#define TESTLOOPCONTROL_PRIVATE_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *

#define PASS_TESTLOOPCONTROL_PRIVATE_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_TESTLOOPCONTROL_PROTECTED_FARGUMENTS \


#define TESTLOOPCONTROL_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_TESTLOOPCONTROL_PROTECTED_CARGUMENTS \


#define DECLARE_TESTLOOPCONTROL_PROTECTED_C2F \


#define INITIALISE_TESTLOOPCONTROL_PROTECTED_C2F \


#define TESTLOOPCONTROL_PROTECTED_C2F_PROTO \


#define PASS_TESTLOOPCONTROL_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_TESTLOOPCONTROL_PUBLIC_FARGUMENTS \
...
#define TESTLOOPCONTROL_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_TESTLOOPCONTROL_PUBLIC_CARGUMENTS \
...
#define DECLARE_TESTLOOPCONTROL_PUBLIC_C2F \
...
#define INITIALISE_TESTLOOPCONTROL_PUBLIC_C2F \
...
#define TESTLOOPCONTROL_PUBLIC_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_TESTLOOPCONTROL_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define TESTLOOPCONTROL_FARGUMENTS _CCTK_FARGUMENTS, TESTLOOPCONTROL_PRIVATE_FARGUMENTS, TESTLOOPCONTROL_PUBLIC_FARGUMENTS

#define DECLARE_TESTLOOPCONTROL_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_TESTLOOPCONTROL_PRIVATE_FARGUMENTS DECLARE_TESTLOOPCONTROL_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_TESTLOOPCONTROL_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_TESTLOOPCONTROL_PRIVATE_CARGUMENTS DECLARE_TESTLOOPCONTROL_PUBLIC_CARGUMENTS

#define TESTLOOPCONTROL_C2F_PROTO _CCTK_C2F_PROTO, TESTLOOPCONTROL_PRIVATE_C2F_PROTO, TESTLOOPCONTROL_PUBLIC_C2F_PROTO

#define PASS_TESTLOOPCONTROL_C2F(GH) _PASS_CCTK_C2F(GH), PASS_TESTLOOPCONTROL_PRIVATE_C2F(GH), PASS_TESTLOOPCONTROL_PUBLIC_C2F(GH)

#define DECLARE_TESTLOOPCONTROL_C2F _DECLARE_CCTK_C2F DECLARE_TESTLOOPCONTROL_PRIVATE_C2F DECLARE_TESTLOOPCONTROL_PUBLIC_C2F

#define INITIALISE_TESTLOOPCONTROL_C2F _INITIALISE_CCTK_C2F INITIALISE_TESTLOOPCONTROL_PRIVATE_C2F INITIALISE_TESTLOOPCONTROL_PUBLIC_C2F

#define TESTLOOPCONTROL_CARGUMENTS cGH *cctkGH
