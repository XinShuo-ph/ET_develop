/*@@
   @header  WaveToyC_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn WaveToyC
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_WAVETOYC_PRIVATE_FARGUMENTS \


#define WAVETOYC_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYC_PRIVATE_CARGUMENTS \


#define DECLARE_WAVETOYC_PRIVATE_C2F \


#define INITIALISE_WAVETOYC_PRIVATE_C2F \


#define WAVETOYC_PRIVATE_C2F_PROTO \


#define PASS_WAVETOYC_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_WAVETOYC_PROTECTED_FARGUMENTS \


#define WAVETOYC_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYC_PROTECTED_CARGUMENTS \


#define DECLARE_WAVETOYC_PROTECTED_C2F \


#define INITIALISE_WAVETOYC_PROTECTED_C2F \


#define WAVETOYC_PROTECTED_C2F_PROTO \


#define PASS_WAVETOYC_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_WAVETOYC_PUBLIC_FARGUMENTS \
...
#define WAVETOYC_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,phi,phi_p,phi_p_p,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYC_PUBLIC_CARGUMENTS \
...
#define DECLARE_WAVETOYC_PUBLIC_C2F \
...
#define INITIALISE_WAVETOYC_PUBLIC_C2F \
...
#ifdef FCODE
#define WAVETOYC_FARGUMENTS _CCTK_FARGUMENTS, WAVETOYC_PUBLIC_FARGUMENTS

#define DECLARE_WAVETOYC_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_WAVETOYC_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYC_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_WAVETOYC_PUBLIC_CARGUMENTS

#define WAVETOYC_C2F_PROTO _CCTK_C2F_PROTO, WAVETOYC_PUBLIC_C2F_PROTO

#define PASS_WAVETOYC_C2F(GH) _PASS_CCTK_C2F(GH), PASS_WAVETOYC_PUBLIC_C2F(GH)

#define DECLARE_WAVETOYC_C2F _DECLARE_CCTK_C2F DECLARE_WAVETOYC_PUBLIC_C2F

#define INITIALISE_WAVETOYC_C2F _INITIALISE_CCTK_C2F INITIALISE_WAVETOYC_PUBLIC_C2F

#define WAVETOYC_CARGUMENTS cGH *cctkGH
