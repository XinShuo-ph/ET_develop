...
#define CCTK_ARGUMENTS NULLVARS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NULLVARS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NULLVARS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NULLVARS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NULLVARS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NULLVARS_FARGUMENTS
#define CCTK_CARGUMENTS NULLVARS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NULLVARS_CARGUMENTS
#endif
