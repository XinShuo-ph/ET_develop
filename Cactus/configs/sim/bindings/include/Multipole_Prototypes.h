...
#ifndef _MULTIPOLE_PROTOTYPES_H_
#define _MULTIPOLE_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_MULTIPOLE_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
