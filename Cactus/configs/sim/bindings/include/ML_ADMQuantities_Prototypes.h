/*@@
   @header  ML_ADMQuantities_Prototypes.h
...
#ifndef _ML_ADMQUANTITIES_PROTOTYPES_H_
#define _ML_ADMQUANTITIES_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_ML_ADMQUANTITIES_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
