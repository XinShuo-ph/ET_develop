...
#define CCTK_ARGUMENTS ADMMASS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ADMMASS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ADMMASS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ADMMASS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ADMMASS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ADMMASS_FARGUMENTS
#define CCTK_CARGUMENTS ADMMASS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ADMMASS_CARGUMENTS
#endif
