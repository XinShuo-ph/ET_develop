...
#include "CarpetRegridTest_Arguments.h"
...
#define CCTK_ARGUMENTS CARPETREGRIDTEST_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETREGRIDTEST_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETREGRIDTEST_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETREGRIDTEST_FARGUMENTS
#endif

#define CCTK_FARGUMENTS CARPETREGRIDTEST_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_CARPETREGRIDTEST_FARGUMENTS
#define CCTK_CARGUMENTS CARPETREGRIDTEST_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_CARPETREGRIDTEST_CARGUMENTS
#endif
