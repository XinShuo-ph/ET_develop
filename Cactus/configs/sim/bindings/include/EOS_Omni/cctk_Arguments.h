...
#define CCTK_ARGUMENTS EOS_OMNI_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EOS_OMNI_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS EOS_OMNI_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EOS_OMNI_FARGUMENTS
#endif

#define CCTK_FARGUMENTS EOS_OMNI_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_EOS_OMNI_FARGUMENTS
#define CCTK_CARGUMENTS EOS_OMNI_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_EOS_OMNI_CARGUMENTS
#endif
