...
#define CCTK_ARGUMENTS TIMERS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TIMERS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TIMERS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TIMERS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TIMERS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TIMERS_FARGUMENTS
#define CCTK_CARGUMENTS TIMERS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TIMERS_CARGUMENTS
#endif
