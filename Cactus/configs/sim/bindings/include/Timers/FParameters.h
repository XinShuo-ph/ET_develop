...
CCTK_DECLARE(CCTK_REAL,threshold_percentage,)&&\
CCTK_DECLARE(CCTK_STRING,xml_clock,)&&\
CCTK_DECLARE(CCTK_INT,disable_cactus_timer_set,)&&\
CCTK_DECLARE(CCTK_INT,disable_timer_trees,)&&\
CCTK_DECLARE(CCTK_INT,output_precision,)&&\
CCTK_DECLARE(CCTK_INT,verbose,)&&\
COMMON /Timerspriv/threshold_percentage, xml_clock, disable_cactus_timer_set, disable_timer_trees, output_precision, verbose&&\
