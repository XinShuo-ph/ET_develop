...
#define CCTK_ARGUMENTS ELLPETSC_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ELLPETSC_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ELLPETSC_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ELLPETSC_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ELLPETSC_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ELLPETSC_FARGUMENTS
#define CCTK_CARGUMENTS ELLPETSC_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ELLPETSC_CARGUMENTS
#endif
