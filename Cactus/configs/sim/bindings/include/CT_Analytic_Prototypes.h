/*@@
   @header  CT_Analytic_Prototypes.h
...
#ifndef _CT_ANALYTIC_PROTOTYPES_H_
#define _CT_ANALYTIC_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_CT_ANALYTIC_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
