...
CCTK_DECLARE(CCTK_INT,Minkowski_MaxNumArrayEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,Minkowski_MaxNumEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,Minkowski_always_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,Minkowski_always_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,Minkowski_exact_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,Minkowski_exact_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,Minkowski_initial_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,Minkowski_initial_calc_offset,)&&\
...
COMMON /Minkowskirest/boostx, boosty, boostz, lapsefactor, phi, positionx, positiony, positionz, psi, shiftaddx, shiftaddy, shiftaddz, theta, timeoffset, Minkowski_MaxNumArrayEvolvedVars, Minkowski_MaxNumEvolvedVars, Minkowski_always_calc_every, Minkowski_always_calc_offset, Minkowski_exact_calc_every, Minkowski_exact_calc_offset, Minkowski_initial_calc_every, Minkowski_initial_calc_offset, other_timelevels, rhs_timelevels, tile_size, timelevels, verbose&&\
CCTK_DECLARE(CCTK_STRING,exact_method,)&&\
COMMON /Minkowskipriv/exact_method&&\
