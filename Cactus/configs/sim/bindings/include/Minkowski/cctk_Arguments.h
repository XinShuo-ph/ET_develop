...
#define CCTK_ARGUMENTS MINKOWSKI_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_MINKOWSKI_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS MINKOWSKI_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_MINKOWSKI_FARGUMENTS
#endif

#define CCTK_FARGUMENTS MINKOWSKI_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_MINKOWSKI_FARGUMENTS
#define CCTK_CARGUMENTS MINKOWSKI_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_MINKOWSKI_CARGUMENTS
#endif
