...
#include "Convert_to_HydroBase_Arguments.h"
...
#define CCTK_ARGUMENTS CONVERT_TO_HYDROBASE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CONVERT_TO_HYDROBASE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CONVERT_TO_HYDROBASE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CONVERT_TO_HYDROBASE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS CONVERT_TO_HYDROBASE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_CONVERT_TO_HYDROBASE_FARGUMENTS
#define CCTK_CARGUMENTS CONVERT_TO_HYDROBASE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_CONVERT_TO_HYDROBASE_CARGUMENTS
#endif
