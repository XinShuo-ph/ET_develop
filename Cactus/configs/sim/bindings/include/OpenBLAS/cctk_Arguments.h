...
#define CCTK_ARGUMENTS OPENBLAS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_OPENBLAS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS OPENBLAS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_OPENBLAS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS OPENBLAS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_OPENBLAS_FARGUMENTS
#define CCTK_CARGUMENTS OPENBLAS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_OPENBLAS_CARGUMENTS
#endif
