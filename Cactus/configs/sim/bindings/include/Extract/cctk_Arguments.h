...
#define CCTK_ARGUMENTS EXTRACT_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EXTRACT_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS EXTRACT_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EXTRACT_FARGUMENTS
#endif

#define CCTK_FARGUMENTS EXTRACT_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_EXTRACT_FARGUMENTS
#define CCTK_CARGUMENTS EXTRACT_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_EXTRACT_CARGUMENTS
#endif
