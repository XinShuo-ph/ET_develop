/*@@
   @header  KerrSchild_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn KerrSchild
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_KERRSCHILD_PRIVATE_FARGUMENTS \


#define KERRSCHILD_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_KERRSCHILD_PRIVATE_CARGUMENTS \


#define DECLARE_KERRSCHILD_PRIVATE_C2F \


#define INITIALISE_KERRSCHILD_PRIVATE_C2F \


#define KERRSCHILD_PRIVATE_C2F_PROTO \


#define PASS_KERRSCHILD_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_KERRSCHILD_PROTECTED_FARGUMENTS \


#define KERRSCHILD_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_KERRSCHILD_PROTECTED_CARGUMENTS \


#define DECLARE_KERRSCHILD_PROTECTED_C2F \


#define INITIALISE_KERRSCHILD_PROTECTED_C2F \


#define KERRSCHILD_PROTECTED_C2F_PROTO \


#define PASS_KERRSCHILD_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_KERRSCHILD_PUBLIC_FARGUMENTS \
...
#define KERRSCHILD_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_KERRSCHILD_PUBLIC_CARGUMENTS \
...
if (cctki_vi_alpExact == -100) cctki_vi_alpExact = CCTK_VarIndex("KerrSchild::alpExact"); \
...
if (cctki_vi_betaExact1 == -100) cctki_vi_betaExact1 = CCTK_VarIndex("KerrSchild::betaExact1"); \
...
if (cctki_vi_betaExact2 == -100) cctki_vi_betaExact2 = CCTK_VarIndex("KerrSchild::betaExact2"); \
...
if (cctki_vi_betaExact3 == -100) cctki_vi_betaExact3 = CCTK_VarIndex("KerrSchild::betaExact3"); \
...
if (cctki_vi_dtalpExact == -100) cctki_vi_dtalpExact = CCTK_VarIndex("KerrSchild::dtalpExact"); \
...
if (cctki_vi_dtbetaExact1 == -100) cctki_vi_dtbetaExact1 = CCTK_VarIndex("KerrSchild::dtbetaExact1"); \
...
if (cctki_vi_dtbetaExact2 == -100) cctki_vi_dtbetaExact2 = CCTK_VarIndex("KerrSchild::dtbetaExact2"); \
...
if (cctki_vi_dtbetaExact3 == -100) cctki_vi_dtbetaExact3 = CCTK_VarIndex("KerrSchild::dtbetaExact3"); \
...
if (cctki_vi_gExact11 == -100) cctki_vi_gExact11 = CCTK_VarIndex("KerrSchild::gExact11"); \
...
if (cctki_vi_gExact12 == -100) cctki_vi_gExact12 = CCTK_VarIndex("KerrSchild::gExact12"); \
...
if (cctki_vi_gExact13 == -100) cctki_vi_gExact13 = CCTK_VarIndex("KerrSchild::gExact13"); \
...
if (cctki_vi_gExact22 == -100) cctki_vi_gExact22 = CCTK_VarIndex("KerrSchild::gExact22"); \
...
if (cctki_vi_gExact23 == -100) cctki_vi_gExact23 = CCTK_VarIndex("KerrSchild::gExact23"); \
...
if (cctki_vi_gExact33 == -100) cctki_vi_gExact33 = CCTK_VarIndex("KerrSchild::gExact33"); \
...
if (cctki_vi_kExact11 == -100) cctki_vi_kExact11 = CCTK_VarIndex("KerrSchild::kExact11"); \
...
if (cctki_vi_kExact12 == -100) cctki_vi_kExact12 = CCTK_VarIndex("KerrSchild::kExact12"); \
...
if (cctki_vi_kExact13 == -100) cctki_vi_kExact13 = CCTK_VarIndex("KerrSchild::kExact13"); \
...
if (cctki_vi_kExact22 == -100) cctki_vi_kExact22 = CCTK_VarIndex("KerrSchild::kExact22"); \
...
if (cctki_vi_kExact23 == -100) cctki_vi_kExact23 = CCTK_VarIndex("KerrSchild::kExact23"); \
...
if (cctki_vi_kExact33 == -100) cctki_vi_kExact33 = CCTK_VarIndex("KerrSchild::kExact33"); \
...
#define DECLARE_KERRSCHILD_PUBLIC_C2F \
...
#define INITIALISE_KERRSCHILD_PUBLIC_C2F \
...
if(CCTKARGNUM_alpExact == -1) CCTKARGNUM_alpExact = CCTK_VarIndex("KerrSchild::alpExact"); \
if(CCTKGROUPNUM_lapse_exact == -1) CCTKGROUPNUM_lapse_exact = CCTK_GroupIndex("KerrSchild::lapse_exact"); \
if(CCTKARGNUM_betaExact1 == -1) CCTKARGNUM_betaExact1 = CCTK_VarIndex("KerrSchild::betaExact1"); \
if(CCTKGROUPNUM_shift_exact == -1) CCTKGROUPNUM_shift_exact = CCTK_GroupIndex("KerrSchild::shift_exact"); \
if(CCTKARGNUM_betaExact2 == -1) CCTKARGNUM_betaExact2 = CCTK_VarIndex("KerrSchild::betaExact2"); \
if(CCTKARGNUM_betaExact3 == -1) CCTKARGNUM_betaExact3 = CCTK_VarIndex("KerrSchild::betaExact3"); \
...
if(CCTKARGNUM_dtalpExact == -1) CCTKARGNUM_dtalpExact = CCTK_VarIndex("KerrSchild::dtalpExact"); \
if(CCTKGROUPNUM_dtlapse_exact == -1) CCTKGROUPNUM_dtlapse_exact = CCTK_GroupIndex("KerrSchild::dtlapse_exact"); \
if(CCTKARGNUM_dtbetaExact1 == -1) CCTKARGNUM_dtbetaExact1 = CCTK_VarIndex("KerrSchild::dtbetaExact1"); \
if(CCTKGROUPNUM_dtshift_exact == -1) CCTKGROUPNUM_dtshift_exact = CCTK_GroupIndex("KerrSchild::dtshift_exact"); \
if(CCTKARGNUM_dtbetaExact2 == -1) CCTKARGNUM_dtbetaExact2 = CCTK_VarIndex("KerrSchild::dtbetaExact2"); \
if(CCTKARGNUM_dtbetaExact3 == -1) CCTKARGNUM_dtbetaExact3 = CCTK_VarIndex("KerrSchild::dtbetaExact3"); \
...
if(CCTKARGNUM_gExact11 == -1) CCTKARGNUM_gExact11 = CCTK_VarIndex("KerrSchild::gExact11"); \
if(CCTKGROUPNUM_metric_exact == -1) CCTKGROUPNUM_metric_exact = CCTK_GroupIndex("KerrSchild::metric_exact"); \
if(CCTKARGNUM_gExact12 == -1) CCTKARGNUM_gExact12 = CCTK_VarIndex("KerrSchild::gExact12"); \
if(CCTKARGNUM_gExact13 == -1) CCTKARGNUM_gExact13 = CCTK_VarIndex("KerrSchild::gExact13"); \
if(CCTKARGNUM_gExact22 == -1) CCTKARGNUM_gExact22 = CCTK_VarIndex("KerrSchild::gExact22"); \
if(CCTKARGNUM_gExact23 == -1) CCTKARGNUM_gExact23 = CCTK_VarIndex("KerrSchild::gExact23"); \
if(CCTKARGNUM_gExact33 == -1) CCTKARGNUM_gExact33 = CCTK_VarIndex("KerrSchild::gExact33"); \
...
if(CCTKARGNUM_kExact11 == -1) CCTKARGNUM_kExact11 = CCTK_VarIndex("KerrSchild::kExact11"); \
if(CCTKGROUPNUM_curv_exact == -1) CCTKGROUPNUM_curv_exact = CCTK_GroupIndex("KerrSchild::curv_exact"); \
if(CCTKARGNUM_kExact12 == -1) CCTKARGNUM_kExact12 = CCTK_VarIndex("KerrSchild::kExact12"); \
if(CCTKARGNUM_kExact13 == -1) CCTKARGNUM_kExact13 = CCTK_VarIndex("KerrSchild::kExact13"); \
if(CCTKARGNUM_kExact22 == -1) CCTKARGNUM_kExact22 = CCTK_VarIndex("KerrSchild::kExact22"); \
if(CCTKARGNUM_kExact23 == -1) CCTKARGNUM_kExact23 = CCTK_VarIndex("KerrSchild::kExact23"); \
if(CCTKARGNUM_kExact33 == -1) CCTKARGNUM_kExact33 = CCTK_VarIndex("KerrSchild::kExact33"); \
...
#define KERRSCHILD_PUBLIC_C2F_PROTO \
...
#define PASS_KERRSCHILD_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define KERRSCHILD_FARGUMENTS _CCTK_FARGUMENTS, KERRSCHILD_PUBLIC_FARGUMENTS

#define DECLARE_KERRSCHILD_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_KERRSCHILD_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_KERRSCHILD_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_KERRSCHILD_PUBLIC_CARGUMENTS

#define KERRSCHILD_C2F_PROTO _CCTK_C2F_PROTO, KERRSCHILD_PUBLIC_C2F_PROTO

#define PASS_KERRSCHILD_C2F(GH) _PASS_CCTK_C2F(GH), PASS_KERRSCHILD_PUBLIC_C2F(GH)

#define DECLARE_KERRSCHILD_C2F _DECLARE_CCTK_C2F DECLARE_KERRSCHILD_PUBLIC_C2F

#define INITIALISE_KERRSCHILD_C2F _INITIALISE_CCTK_C2F INITIALISE_KERRSCHILD_PUBLIC_C2F

#define KERRSCHILD_CARGUMENTS cGH *cctkGH
