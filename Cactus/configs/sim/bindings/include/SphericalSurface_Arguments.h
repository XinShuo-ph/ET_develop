...
CCTK_DECLARE(CCTK_REAL,sf_delta_phi_estimate,(sf_coordinate_estimators_length))&&\
CCTK_DECLARE(CCTK_REAL,sf_delta_theta_estimate,(sf_coordinate_estimators_length))&&\
...
static int cctki_vi_sf_delta_phi_estimate = -100; \
if (cctki_vi_sf_delta_phi_estimate == -100) cctki_vi_sf_delta_phi_estimate = CCTK_VarIndex("SphericalSurface::sf_delta_phi_estimate[0]"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, sf_delta_phi_estimate, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_sf_delta_phi_estimate)); \
static int cctki_vi_sf_delta_theta_estimate = -100; \
if (cctki_vi_sf_delta_theta_estimate == -100) cctki_vi_sf_delta_theta_estimate = CCTK_VarIndex("SphericalSurface::sf_delta_theta_estimate[0]"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, sf_delta_theta_estimate, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_sf_delta_theta_estimate));
