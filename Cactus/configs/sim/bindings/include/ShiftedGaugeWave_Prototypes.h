/*@@
   @header  ShiftedGaugeWave_Prototypes.h
...
#ifndef _SHIFTEDGAUGEWAVE_PROTOTYPES_H_
#define _SHIFTEDGAUGEWAVE_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_SHIFTEDGAUGEWAVE_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
