...
#include "TestCoordinates_Arguments.h"
...
#define CCTK_ARGUMENTS TESTCOORDINATES_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTCOORDINATES_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTCOORDINATES_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTCOORDINATES_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTCOORDINATES_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTCOORDINATES_FARGUMENTS
#define CCTK_CARGUMENTS TESTCOORDINATES_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTCOORDINATES_CARGUMENTS
#endif
