...
#define CCTK_ARGUMENTS PETSC_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PETSC_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS PETSC_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PETSC_FARGUMENTS
#endif

#define CCTK_FARGUMENTS PETSC_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_PETSC_FARGUMENTS
#define CCTK_CARGUMENTS PETSC_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_PETSC_CARGUMENTS
#endif
