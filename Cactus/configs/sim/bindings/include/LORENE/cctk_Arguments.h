...
#define CCTK_ARGUMENTS LORENE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_LORENE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS LORENE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_LORENE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS LORENE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_LORENE_FARGUMENTS
#define CCTK_CARGUMENTS LORENE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_LORENE_CARGUMENTS
#endif
