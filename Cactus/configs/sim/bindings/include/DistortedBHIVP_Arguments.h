/*@@
   @header  DistortedBHIVP_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn DistortedBHIVP
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_DISTORTEDBHIVP_PRIVATE_FARGUMENTS \
...
#define DISTORTEDBHIVP_PRIVATE_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_DISTORTEDBHIVP_PRIVATE_CARGUMENTS \
static int cctki_vi_abseta = -100; \
if (cctki_vi_abseta == -100) cctki_vi_abseta = CCTK_VarIndex("DistortedBHIVP::abseta"); \
...
if (cctki_vi_detaetapsi3d == -100) cctki_vi_detaetapsi3d = CCTK_VarIndex("DistortedBHIVP::detaetapsi3d"); \
...
if (cctki_vi_detaphipsi3d == -100) cctki_vi_detaphipsi3d = CCTK_VarIndex("DistortedBHIVP::detaphipsi3d"); \
...
if (cctki_vi_detapsi3d == -100) cctki_vi_detapsi3d = CCTK_VarIndex("DistortedBHIVP::detapsi3d"); \
...
if (cctki_vi_detaqpsi3d == -100) cctki_vi_detaqpsi3d = CCTK_VarIndex("DistortedBHIVP::detaqpsi3d"); \
...
if (cctki_vi_dphiphipsi3d == -100) cctki_vi_dphiphipsi3d = CCTK_VarIndex("DistortedBHIVP::dphiphipsi3d"); \
...
if (cctki_vi_dphipsi3d == -100) cctki_vi_dphipsi3d = CCTK_VarIndex("DistortedBHIVP::dphipsi3d"); \
...
if (cctki_vi_dqphipsi3d == -100) cctki_vi_dqphipsi3d = CCTK_VarIndex("DistortedBHIVP::dqphipsi3d"); \
...
if (cctki_vi_dqpsi3d == -100) cctki_vi_dqpsi3d = CCTK_VarIndex("DistortedBHIVP::dqpsi3d"); \
...
if (cctki_vi_dqqpsi3d == -100) cctki_vi_dqqpsi3d = CCTK_VarIndex("DistortedBHIVP::dqqpsi3d"); \
...
if (cctki_vi_eta == -100) cctki_vi_eta = CCTK_VarIndex("DistortedBHIVP::eta"); \
...
if (cctki_vi_phi == -100) cctki_vi_phi = CCTK_VarIndex("DistortedBHIVP::phi"); \
...
if (cctki_vi_psi3d == -100) cctki_vi_psi3d = CCTK_VarIndex("DistortedBHIVP::psi3d"); \
...
if (cctki_vi_q == -100) cctki_vi_q = CCTK_VarIndex("DistortedBHIVP::q"); \
...
if (cctki_vi_sign_eta == -100) cctki_vi_sign_eta = CCTK_VarIndex("DistortedBHIVP::sign_eta"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, sign_eta, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_sign_eta));

#define DECLARE_DISTORTEDBHIVP_PRIVATE_C2F \
...
#define INITIALISE_DISTORTEDBHIVP_PRIVATE_C2F \
if(CCTKARGNUM_abseta == -1) CCTKARGNUM_abseta = CCTK_VarIndex("DistortedBHIVP::abseta"); \
if(CCTKGROUPNUM_sph_to_car_coord == -1) CCTKGROUPNUM_sph_to_car_coord = CCTK_GroupIndex("DistortedBHIVP::sph_to_car_coord"); \
if(CCTKARGNUM_detaetapsi3d == -1) CCTKARGNUM_detaetapsi3d = CCTK_VarIndex("DistortedBHIVP::detaetapsi3d"); \
if(CCTKGROUPNUM_sph_to_car_psi == -1) CCTKGROUPNUM_sph_to_car_psi = CCTK_GroupIndex("DistortedBHIVP::sph_to_car_psi"); \
if(CCTKARGNUM_detaphipsi3d == -1) CCTKARGNUM_detaphipsi3d = CCTK_VarIndex("DistortedBHIVP::detaphipsi3d"); \
if(CCTKARGNUM_detapsi3d == -1) CCTKARGNUM_detapsi3d = CCTK_VarIndex("DistortedBHIVP::detapsi3d"); \
if(CCTKARGNUM_detaqpsi3d == -1) CCTKARGNUM_detaqpsi3d = CCTK_VarIndex("DistortedBHIVP::detaqpsi3d"); \
if(CCTKARGNUM_dphiphipsi3d == -1) CCTKARGNUM_dphiphipsi3d = CCTK_VarIndex("DistortedBHIVP::dphiphipsi3d"); \
if(CCTKARGNUM_dphipsi3d == -1) CCTKARGNUM_dphipsi3d = CCTK_VarIndex("DistortedBHIVP::dphipsi3d"); \
if(CCTKARGNUM_dqphipsi3d == -1) CCTKARGNUM_dqphipsi3d = CCTK_VarIndex("DistortedBHIVP::dqphipsi3d"); \
if(CCTKARGNUM_dqpsi3d == -1) CCTKARGNUM_dqpsi3d = CCTK_VarIndex("DistortedBHIVP::dqpsi3d"); \
if(CCTKARGNUM_dqqpsi3d == -1) CCTKARGNUM_dqqpsi3d = CCTK_VarIndex("DistortedBHIVP::dqqpsi3d"); \
if(CCTKARGNUM_eta == -1) CCTKARGNUM_eta = CCTK_VarIndex("DistortedBHIVP::eta"); \
if(CCTKARGNUM_phi == -1) CCTKARGNUM_phi = CCTK_VarIndex("DistortedBHIVP::phi"); \
if(CCTKARGNUM_psi3d == -1) CCTKARGNUM_psi3d = CCTK_VarIndex("DistortedBHIVP::psi3d"); \
if(CCTKARGNUM_q == -1) CCTKARGNUM_q = CCTK_VarIndex("DistortedBHIVP::q"); \
if(CCTKARGNUM_sign_eta == -1) CCTKARGNUM_sign_eta = CCTK_VarIndex("DistortedBHIVP::sign_eta");

#define DISTORTEDBHIVP_PRIVATE_C2F_PROTO \
...
#define PASS_DISTORTEDBHIVP_PRIVATE_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_DISTORTEDBHIVP_PROTECTED_FARGUMENTS \


#define DISTORTEDBHIVP_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_DISTORTEDBHIVP_PROTECTED_CARGUMENTS \


#define DECLARE_DISTORTEDBHIVP_PROTECTED_C2F \


#define INITIALISE_DISTORTEDBHIVP_PROTECTED_C2F \


#define DISTORTEDBHIVP_PROTECTED_C2F_PROTO \


#define PASS_DISTORTEDBHIVP_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_DISTORTEDBHIVP_PUBLIC_FARGUMENTS \
...
#define DISTORTEDBHIVP_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_DISTORTEDBHIVP_PUBLIC_CARGUMENTS \
...
#define DECLARE_DISTORTEDBHIVP_PUBLIC_C2F \
...
#define INITIALISE_DISTORTEDBHIVP_PUBLIC_C2F \
...
#define DISTORTEDBHIVP_PUBLIC_C2F_PROTO \
...
#define PASS_DISTORTEDBHIVP_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define DISTORTEDBHIVP_FARGUMENTS _CCTK_FARGUMENTS, DISTORTEDBHIVP_PRIVATE_FARGUMENTS, DISTORTEDBHIVP_PUBLIC_FARGUMENTS

#define DECLARE_DISTORTEDBHIVP_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_DISTORTEDBHIVP_PRIVATE_FARGUMENTS DECLARE_DISTORTEDBHIVP_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_DISTORTEDBHIVP_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_DISTORTEDBHIVP_PRIVATE_CARGUMENTS DECLARE_DISTORTEDBHIVP_PUBLIC_CARGUMENTS

#define DISTORTEDBHIVP_C2F_PROTO _CCTK_C2F_PROTO, DISTORTEDBHIVP_PRIVATE_C2F_PROTO, DISTORTEDBHIVP_PUBLIC_C2F_PROTO

#define PASS_DISTORTEDBHIVP_C2F(GH) _PASS_CCTK_C2F(GH), PASS_DISTORTEDBHIVP_PRIVATE_C2F(GH), PASS_DISTORTEDBHIVP_PUBLIC_C2F(GH)

#define DECLARE_DISTORTEDBHIVP_C2F _DECLARE_CCTK_C2F DECLARE_DISTORTEDBHIVP_PRIVATE_C2F DECLARE_DISTORTEDBHIVP_PUBLIC_C2F

#define INITIALISE_DISTORTEDBHIVP_C2F _INITIALISE_CCTK_C2F INITIALISE_DISTORTEDBHIVP_PRIVATE_C2F INITIALISE_DISTORTEDBHIVP_PUBLIC_C2F

#define DISTORTEDBHIVP_CARGUMENTS cGH *cctkGH
