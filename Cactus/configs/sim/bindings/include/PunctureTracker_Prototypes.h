/*@@
   @header  PunctureTracker_Prototypes.h
...
#ifndef _PUNCTURETRACKER_PROTOTYPES_H_
#define _PUNCTURETRACKER_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_PUNCTURETRACKER_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
