...
#include "ReductionTest_Arguments.h"
...
#define CCTK_ARGUMENTS REDUCTIONTEST_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_REDUCTIONTEST_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS REDUCTIONTEST_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_REDUCTIONTEST_FARGUMENTS
#endif

#define CCTK_FARGUMENTS REDUCTIONTEST_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_REDUCTIONTEST_FARGUMENTS
#define CCTK_CARGUMENTS REDUCTIONTEST_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_REDUCTIONTEST_CARGUMENTS
#endif
