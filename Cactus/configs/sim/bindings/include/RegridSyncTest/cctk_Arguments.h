...
#include "RegridSyncTest_Arguments.h"
...
#define CCTK_ARGUMENTS REGRIDSYNCTEST_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_REGRIDSYNCTEST_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS REGRIDSYNCTEST_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_REGRIDSYNCTEST_FARGUMENTS
#endif

#define CCTK_FARGUMENTS REGRIDSYNCTEST_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_REGRIDSYNCTEST_FARGUMENTS
#define CCTK_CARGUMENTS REGRIDSYNCTEST_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_REGRIDSYNCTEST_CARGUMENTS
#endif
