...
#define CCTK_ARGUMENTS ELLSOR_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ELLSOR_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ELLSOR_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ELLSOR_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ELLSOR_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ELLSOR_FARGUMENTS
#define CCTK_CARGUMENTS ELLSOR_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ELLSOR_CARGUMENTS
#endif
