...
#define CCTK_ARGUMENTS WATCHDOG_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WATCHDOG_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS WATCHDOG_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WATCHDOG_FARGUMENTS
#endif

#define CCTK_FARGUMENTS WATCHDOG_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_WATCHDOG_FARGUMENTS
#define CCTK_CARGUMENTS WATCHDOG_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_WATCHDOG_CARGUMENTS
#endif
