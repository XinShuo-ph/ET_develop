...
#define CCTK_ARGUMENTS NOISE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NOISE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NOISE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NOISE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NOISE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NOISE_FARGUMENTS
#define CCTK_CARGUMENTS NOISE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NOISE_CARGUMENTS
#endif
