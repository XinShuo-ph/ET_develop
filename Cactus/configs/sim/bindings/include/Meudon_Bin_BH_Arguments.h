/*@@
   @header  Meudon_Bin_BH_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn Meudon_Bin_BH
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_MEUDON_BIN_BH_PRIVATE_FARGUMENTS \


#define MEUDON_BIN_BH_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MEUDON_BIN_BH_PRIVATE_CARGUMENTS \


#define DECLARE_MEUDON_BIN_BH_PRIVATE_C2F \


#define INITIALISE_MEUDON_BIN_BH_PRIVATE_C2F \


#define MEUDON_BIN_BH_PRIVATE_C2F_PROTO \


#define PASS_MEUDON_BIN_BH_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_MEUDON_BIN_BH_PROTECTED_FARGUMENTS \


#define MEUDON_BIN_BH_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MEUDON_BIN_BH_PROTECTED_CARGUMENTS \


#define DECLARE_MEUDON_BIN_BH_PROTECTED_C2F \


#define INITIALISE_MEUDON_BIN_BH_PROTECTED_C2F \


#define MEUDON_BIN_BH_PROTECTED_C2F_PROTO \


#define PASS_MEUDON_BIN_BH_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_MEUDON_BIN_BH_PUBLIC_FARGUMENTS \
...
#define MEUDON_BIN_BH_PUBLIC_FARGUMENTS \
alp,alp_p,alp_p_p,betax,betax_p,betax_p_p,betay,betay_p,betay_p_p,betaz,betaz_p,betaz_p_p,coarse_dx,coarse_dy,coarse_dz,dtalp,dtalp_p,dtalp_p_p,dtbetax,dtbetax_p,dtbetax_p_p,dtbetay,dtbetay_p,dtbetay_p_p,dtbetaz,dtbetaz_p,dtbetaz_p_p,dtlapse_state,dtshift_state,gxx,gxx_p,gxx_p_p,gxy,gxy_p,gxy_p_p,gxz,gxz_p,gxz_p_p,gyy,gyy_p,gyy_p_p,gyz,gyz_p,gyz_p_p,gzz,gzz_p,gzz_p_p,kxx,kxx_p,kxx_p_p,kxy,kxy_p,kxy_p_p,kxz,kxz_p,kxz_p_p,kyy,kyy_p,kyy_p_p,kyz,kyz_p,kyz_p_p,kzz,kzz_p,kzz_p_p,nmask,r,sbp_dx,sbp_dy,sbp_dz,shift_state,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MEUDON_BIN_BH_PUBLIC_CARGUMENTS \
...
#define DECLARE_MEUDON_BIN_BH_PUBLIC_C2F \
...
#define INITIALISE_MEUDON_BIN_BH_PUBLIC_C2F \
...
#define MEUDON_BIN_BH_PUBLIC_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_MEUDON_BIN_BH_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define MEUDON_BIN_BH_FARGUMENTS _CCTK_FARGUMENTS, MEUDON_BIN_BH_PUBLIC_FARGUMENTS

#define DECLARE_MEUDON_BIN_BH_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_MEUDON_BIN_BH_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MEUDON_BIN_BH_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_MEUDON_BIN_BH_PUBLIC_CARGUMENTS

#define MEUDON_BIN_BH_C2F_PROTO _CCTK_C2F_PROTO, MEUDON_BIN_BH_PUBLIC_C2F_PROTO

#define PASS_MEUDON_BIN_BH_C2F(GH) _PASS_CCTK_C2F(GH), PASS_MEUDON_BIN_BH_PUBLIC_C2F(GH)

#define DECLARE_MEUDON_BIN_BH_C2F _DECLARE_CCTK_C2F DECLARE_MEUDON_BIN_BH_PUBLIC_C2F

#define INITIALISE_MEUDON_BIN_BH_C2F _INITIALISE_CCTK_C2F INITIALISE_MEUDON_BIN_BH_PUBLIC_C2F

#define MEUDON_BIN_BH_CARGUMENTS cGH *cctkGH
