...
#define CCTK_ARGUMENTS ZLIB_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ZLIB_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ZLIB_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ZLIB_FARGUMENTS
#endif
