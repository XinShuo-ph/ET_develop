...
#define CCTK_ARGUMENTS CARPETIOHDF5_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETIOHDF5_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETIOHDF5_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETIOHDF5_FARGUMENTS
#endif
