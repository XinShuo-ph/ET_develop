...
#define CCTK_ARGUMENTS IOJPEG_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IOJPEG_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS IOJPEG_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IOJPEG_FARGUMENTS
#endif

#define CCTK_FARGUMENTS IOJPEG_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_IOJPEG_FARGUMENTS
#define CCTK_CARGUMENTS IOJPEG_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_IOJPEG_CARGUMENTS
#endif
