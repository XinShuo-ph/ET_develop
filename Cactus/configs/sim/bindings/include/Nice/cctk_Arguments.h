...
#define CCTK_ARGUMENTS NICE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NICE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NICE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NICE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NICE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NICE_FARGUMENTS
#define CCTK_CARGUMENTS NICE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NICE_CARGUMENTS
#endif
