...
#define CCTK_ARGUMENTS SPACEMASK_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SPACEMASK_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SPACEMASK_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SPACEMASK_FARGUMENTS
#endif
