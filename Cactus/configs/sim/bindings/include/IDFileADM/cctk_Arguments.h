...
#define CCTK_ARGUMENTS IDFILEADM_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDFILEADM_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS IDFILEADM_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDFILEADM_FARGUMENTS
#endif

#define CCTK_FARGUMENTS IDFILEADM_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_IDFILEADM_FARGUMENTS
#define CCTK_CARGUMENTS IDFILEADM_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_IDFILEADM_CARGUMENTS
#endif
