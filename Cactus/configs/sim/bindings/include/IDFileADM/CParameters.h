/*@@
   @header  IDFileADM/CParameters.h
   @author  Automatically generated by CreateParameterBindings.pl
   @desc
            Declares parameters of thorn IDFileADM
   @enddesc
 @@*/


#ifndef _IDFILEADM_PARAMETERS_H_
#define _IDFILEADM_PARAMETERS_H_ 1
...
#endif  /* _IDFILEADM_PARAMETERS_H_ */
