...
#define CCTK_ARGUMENTS AEILOCALINTERP_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_AEILOCALINTERP_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS AEILOCALINTERP_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_AEILOCALINTERP_FARGUMENTS
#endif
