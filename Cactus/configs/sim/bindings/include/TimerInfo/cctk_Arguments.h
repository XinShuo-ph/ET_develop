...
#define CCTK_ARGUMENTS TIMERINFO_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TIMERINFO_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TIMERINFO_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TIMERINFO_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TIMERINFO_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TIMERINFO_FARGUMENTS
#define CCTK_CARGUMENTS TIMERINFO_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TIMERINFO_CARGUMENTS
#endif
