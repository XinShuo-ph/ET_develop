...
#include "TestGlobalReduce_Arguments.h"
...
#define CCTK_ARGUMENTS TESTGLOBALREDUCE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTGLOBALREDUCE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTGLOBALREDUCE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTGLOBALREDUCE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTGLOBALREDUCE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTGLOBALREDUCE_FARGUMENTS
#define CCTK_CARGUMENTS TESTGLOBALREDUCE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTGLOBALREDUCE_CARGUMENTS
#endif
