...
#define CCTK_ARGUMENTS FORMALINE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_FORMALINE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS FORMALINE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_FORMALINE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS FORMALINE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_FORMALINE_FARGUMENTS
#define CCTK_CARGUMENTS FORMALINE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_FORMALINE_CARGUMENTS
#endif
