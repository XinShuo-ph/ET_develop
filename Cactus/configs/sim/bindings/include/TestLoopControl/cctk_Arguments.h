...
#include "TestLoopControl_Arguments.h"
...
#define CCTK_ARGUMENTS TESTLOOPCONTROL_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTLOOPCONTROL_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTLOOPCONTROL_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTLOOPCONTROL_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTLOOPCONTROL_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTLOOPCONTROL_FARGUMENTS
#define CCTK_CARGUMENTS TESTLOOPCONTROL_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTLOOPCONTROL_CARGUMENTS
#endif
