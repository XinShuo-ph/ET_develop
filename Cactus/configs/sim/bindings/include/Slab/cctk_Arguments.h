...
#define CCTK_ARGUMENTS SLAB_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SLAB_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SLAB_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SLAB_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SLAB_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SLAB_FARGUMENTS
#define CCTK_CARGUMENTS SLAB_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SLAB_CARGUMENTS
#endif
