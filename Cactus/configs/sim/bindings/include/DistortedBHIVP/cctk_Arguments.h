...
#include "DistortedBHIVP_Arguments.h"
...
#define CCTK_ARGUMENTS DISTORTEDBHIVP_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_DISTORTEDBHIVP_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS DISTORTEDBHIVP_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_DISTORTEDBHIVP_FARGUMENTS
#endif

#define CCTK_FARGUMENTS DISTORTEDBHIVP_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_DISTORTEDBHIVP_FARGUMENTS
#define CCTK_CARGUMENTS DISTORTEDBHIVP_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_DISTORTEDBHIVP_CARGUMENTS
#endif
