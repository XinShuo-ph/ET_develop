...
#define CCTK_ARGUMENTS PAPI_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PAPI_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS PAPI_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PAPI_FARGUMENTS
#endif

#define CCTK_FARGUMENTS PAPI_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_PAPI_FARGUMENTS
#define CCTK_CARGUMENTS PAPI_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_PAPI_CARGUMENTS
#endif
