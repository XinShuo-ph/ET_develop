...
#include "EOS_IdealFluid_Arguments.h"
...
#define CCTK_ARGUMENTS EOS_IDEALFLUID_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EOS_IDEALFLUID_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS EOS_IDEALFLUID_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EOS_IDEALFLUID_FARGUMENTS
#endif

#define CCTK_FARGUMENTS EOS_IDEALFLUID_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_EOS_IDEALFLUID_FARGUMENTS
#define CCTK_CARGUMENTS EOS_IDEALFLUID_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_EOS_IDEALFLUID_CARGUMENTS
#endif
