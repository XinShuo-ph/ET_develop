...
#include "HighOrderWaveTest_Arguments.h"
...
#define CCTK_ARGUMENTS HIGHORDERWAVETEST_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HIGHORDERWAVETEST_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS HIGHORDERWAVETEST_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HIGHORDERWAVETEST_FARGUMENTS
#endif

#define CCTK_FARGUMENTS HIGHORDERWAVETEST_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_HIGHORDERWAVETEST_FARGUMENTS
#define CCTK_CARGUMENTS HIGHORDERWAVETEST_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_HIGHORDERWAVETEST_CARGUMENTS
#endif
