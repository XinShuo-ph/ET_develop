/*@@
   @header  KerrSchild_Prototypes.h
...
#ifndef _KERRSCHILD_PROTOTYPES_H_
#define _KERRSCHILD_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_KERRSCHILD_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
