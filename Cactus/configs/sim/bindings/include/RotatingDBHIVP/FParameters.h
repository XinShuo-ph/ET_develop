...
CCTK_DECLARE(CCTK_INT,kerr_shift,)&&\
CCTK_DECLARE(CCTK_INT,kerr_slice,)&&\
CCTK_DECLARE(CCTK_INT,neta,)&&\
CCTK_DECLARE(CCTK_INT,nphi,)&&\
CCTK_DECLARE(CCTK_INT,ntheta,)&&\
CCTK_DECLARE(CCTK_INT,verbose,)&&\
COMMON /RotatingDBHIVPpriv/amp, byJ, eta0, etamax, mm, sigma, interpolation_order, kerr_shift, kerr_slice, neta, nphi, ntheta, verbose&&\
