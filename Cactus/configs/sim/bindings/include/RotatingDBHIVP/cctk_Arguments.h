...
#include "RotatingDBHIVP_Arguments.h"
...
#define CCTK_ARGUMENTS ROTATINGDBHIVP_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ROTATINGDBHIVP_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ROTATINGDBHIVP_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ROTATINGDBHIVP_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ROTATINGDBHIVP_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ROTATINGDBHIVP_FARGUMENTS
#define CCTK_CARGUMENTS ROTATINGDBHIVP_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ROTATINGDBHIVP_CARGUMENTS
#endif
