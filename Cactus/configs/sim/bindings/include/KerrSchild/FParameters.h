...
CCTK_DECLARE(CCTK_INT,KerrSchild_MaxNumArrayEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,KerrSchild_MaxNumEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,KerrSchild_always_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,KerrSchild_always_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,KerrSchild_exact_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,KerrSchild_exact_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,KerrSchild_initial_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,KerrSchild_initial_calc_offset,)&&\
...
COMMON /KerrSchildrest/M, a, boostx, boosty, boostz, lapsefactor, phi, positionx, positiony, positionz, psi, shiftaddx, shiftaddy, shiftaddz, theta, timeoffset, KerrSchild_MaxNumArrayEvolvedVars, KerrSchild_MaxNumEvolvedVars, KerrSchild_always_calc_every, KerrSchild_always_calc_offset, KerrSchild_exact_calc_every, KerrSchild_exact_calc_offset, KerrSchild_initial_calc_every, KerrSchild_initial_calc_offset, other_timelevels, rhs_timelevels, tile_size, timelevels, verbose&&\
CCTK_DECLARE(CCTK_STRING,exact_method,)&&\
COMMON /KerrSchildpriv/exact_method&&\
