...
#ifndef _WEYLSCAL4_PROTOTYPES_H_
#define _WEYLSCAL4_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_WEYLSCAL4_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
