...
CCTK_DECLARE(CCTK_REAL,max_walltime,)&&\
CCTK_DECLARE(CCTK_REAL,on_remaining_walltime,)&&\
CCTK_DECLARE(CCTK_REAL,output_remtime_every_minutes,)&&\
CCTK_DECLARE(CCTK_STRING,termination_file,)&&\
CCTK_DECLARE(CCTK_INT,check_file_every,)&&\
CCTK_DECLARE(CCTK_INT,create_termination_file,)&&\
CCTK_DECLARE(CCTK_INT,termination_from_file,)&&\
COMMON /TerminationTriggerpriv/max_walltime, on_remaining_walltime, output_remtime_every_minutes, termination_file, check_file_every, create_termination_file, termination_from_file&&\
