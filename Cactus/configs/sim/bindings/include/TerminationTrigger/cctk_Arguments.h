...
#include "TerminationTrigger_Arguments.h"
...
#define CCTK_ARGUMENTS TERMINATIONTRIGGER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TERMINATIONTRIGGER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TERMINATIONTRIGGER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TERMINATIONTRIGGER_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TERMINATIONTRIGGER_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TERMINATIONTRIGGER_FARGUMENTS
#define CCTK_CARGUMENTS TERMINATIONTRIGGER_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TERMINATIONTRIGGER_CARGUMENTS
#endif
