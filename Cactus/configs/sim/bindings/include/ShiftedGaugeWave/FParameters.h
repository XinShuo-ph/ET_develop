...
CCTK_DECLARE(CCTK_INT,ShiftedGaugeWave_MaxNumArrayEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,ShiftedGaugeWave_MaxNumEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,ShiftedGaugeWave_always_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ShiftedGaugeWave_always_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ShiftedGaugeWave_exact_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ShiftedGaugeWave_exact_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ShiftedGaugeWave_initial_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ShiftedGaugeWave_initial_calc_offset,)&&\
...
COMMON /ShiftedGaugeWaverest/amp, boostx, boosty, boostz, lapsefactor, period, phi, positionx, positiony, positionz, psi, shiftaddx, shiftaddy, shiftaddz, theta, timeoffset, ShiftedGaugeWave_MaxNumArrayEvolvedVars, ShiftedGaugeWave_MaxNumEvolvedVars, ShiftedGaugeWave_always_calc_every, ShiftedGaugeWave_always_calc_offset, ShiftedGaugeWave_exact_calc_every, ShiftedGaugeWave_exact_calc_offset, ShiftedGaugeWave_initial_calc_every, ShiftedGaugeWave_initial_calc_offset, other_timelevels, rhs_timelevels, tile_size, timelevels, verbose&&\
CCTK_DECLARE(CCTK_STRING,exact_method,)&&\
COMMON /ShiftedGaugeWavepriv/exact_method&&\
