...
#define CCTK_ARGUMENTS TESTLOOP_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTLOOP_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTLOOP_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTLOOP_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTLOOP_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTLOOP_FARGUMENTS
#define CCTK_CARGUMENTS TESTLOOP_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTLOOP_CARGUMENTS
#endif
