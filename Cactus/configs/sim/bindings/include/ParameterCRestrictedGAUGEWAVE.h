...
extern struct
{
  ...
  CCTK_INT GaugeWave_exact_calc_every;
  CCTK_INT GaugeWave_exact_calc_offset;
...
#define DECLARE_RESTRICTED_GAUGEWAVE_STRUCT_PARAMS \
  ...
  CCTK_DECLARE_INIT (CCTK_INT const, GaugeWave_exact_calc_every, CCTK_PARAMETER__GAUGEWAVE__GaugeWave_exact_calc_every); \
  CCTK_DECLARE_INIT (CCTK_INT const, GaugeWave_exact_calc_offset, CCTK_PARAMETER__GAUGEWAVE__GaugeWave_exact_calc_offset); \
  ...
  CCTK_DECLARE_INIT (CCTK_INT const, tile_size, CCTK_PARAMETER__GAUGEWAVE__tile_size); \
...
#endif
#ifndef CCTK_PARAMETER__GAUGEWAVE__GaugeWave_exact_calc_every
#  define CCTK_PARAMETER__GAUGEWAVE__GaugeWave_exact_calc_every RESTRICTED_GAUGEWAVE_STRUCT.GaugeWave_exact_calc_every
#endif
#ifndef CCTK_PARAMETER__GAUGEWAVE__GaugeWave_exact_calc_offset
#  define CCTK_PARAMETER__GAUGEWAVE__GaugeWave_exact_calc_offset RESTRICTED_GAUGEWAVE_STRUCT.GaugeWave_exact_calc_offset
#endif
...
#endif
#ifndef CCTK_PARAMETER__GAUGEWAVE__tile_size
#  define CCTK_PARAMETER__GAUGEWAVE__tile_size RESTRICTED_GAUGEWAVE_STRUCT.tile_size
#endif
