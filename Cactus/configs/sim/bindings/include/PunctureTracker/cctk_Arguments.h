...
#include "PunctureTracker_Arguments.h"
...
#define CCTK_ARGUMENTS PUNCTURETRACKER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PUNCTURETRACKER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS PUNCTURETRACKER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PUNCTURETRACKER_FARGUMENTS
#endif

#define CCTK_FARGUMENTS PUNCTURETRACKER_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_PUNCTURETRACKER_FARGUMENTS
#define CCTK_CARGUMENTS PUNCTURETRACKER_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_PUNCTURETRACKER_CARGUMENTS
#endif
