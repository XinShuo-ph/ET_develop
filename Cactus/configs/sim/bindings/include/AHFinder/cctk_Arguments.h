...
#define CCTK_ARGUMENTS AHFINDER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_AHFINDER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS AHFINDER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_AHFINDER_FARGUMENTS
#endif

#define CCTK_FARGUMENTS AHFINDER_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_AHFINDER_FARGUMENTS
#define CCTK_CARGUMENTS AHFINDER_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_AHFINDER_CARGUMENTS
#endif
