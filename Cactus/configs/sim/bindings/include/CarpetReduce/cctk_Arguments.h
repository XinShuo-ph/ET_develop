...
#define CCTK_ARGUMENTS CARPETREDUCE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETREDUCE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETREDUCE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETREDUCE_FARGUMENTS
#endif
