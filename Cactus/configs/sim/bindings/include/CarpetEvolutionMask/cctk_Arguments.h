...
#define CCTK_ARGUMENTS CARPETEVOLUTIONMASK_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETEVOLUTIONMASK_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETEVOLUTIONMASK_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETEVOLUTIONMASK_FARGUMENTS
#endif
