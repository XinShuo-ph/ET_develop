/*@@
   @header  CarpetIOScalar_Prototypes.h
...
#ifndef _CARPETIOSCALAR_PROTOTYPES_H_
#define _CARPETIOSCALAR_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_CARPETIOSCALAR_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
