...
#define CCTK_ARGUMENTS MEMSPEED_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_MEMSPEED_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS MEMSPEED_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_MEMSPEED_FARGUMENTS
#endif

#define CCTK_FARGUMENTS MEMSPEED_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_MEMSPEED_FARGUMENTS
#define CCTK_CARGUMENTS MEMSPEED_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_MEMSPEED_CARGUMENTS
#endif
