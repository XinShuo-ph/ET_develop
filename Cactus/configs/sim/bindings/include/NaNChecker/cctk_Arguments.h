...
#define CCTK_ARGUMENTS NANCHECKER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NANCHECKER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NANCHECKER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NANCHECKER_FARGUMENTS
#endif
