/*@@
   @header  NullEvolve_Prototypes.h
...
#ifndef _NULLEVOLVE_PROTOTYPES_H_
#define _NULLEVOLVE_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_NULLEVOLVE_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
