...
#define CCTK_ARGUMENTS CARPETTRACKER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETTRACKER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETTRACKER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETTRACKER_FARGUMENTS
#endif
