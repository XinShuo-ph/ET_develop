...
#include "TestCarpetGridInfo_Arguments.h"
...
#define CCTK_ARGUMENTS TESTCARPETGRIDINFO_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTCARPETGRIDINFO_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTCARPETGRIDINFO_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTCARPETGRIDINFO_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTCARPETGRIDINFO_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTCARPETGRIDINFO_FARGUMENTS
#define CCTK_CARGUMENTS TESTCARPETGRIDINFO_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTCARPETGRIDINFO_CARGUMENTS
#endif
