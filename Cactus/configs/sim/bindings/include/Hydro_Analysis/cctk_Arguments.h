...
#include "Hydro_Analysis_Arguments.h"
...
#define CCTK_ARGUMENTS HYDRO_ANALYSIS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HYDRO_ANALYSIS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS HYDRO_ANALYSIS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HYDRO_ANALYSIS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS HYDRO_ANALYSIS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_HYDRO_ANALYSIS_FARGUMENTS
#define CCTK_CARGUMENTS HYDRO_ANALYSIS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_HYDRO_ANALYSIS_CARGUMENTS
#endif
