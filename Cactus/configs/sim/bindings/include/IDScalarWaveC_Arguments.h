/*@@
   @header  IDScalarWaveC_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn IDScalarWaveC
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_IDSCALARWAVEC_PRIVATE_FARGUMENTS \


#define IDSCALARWAVEC_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDSCALARWAVEC_PRIVATE_CARGUMENTS \


#define DECLARE_IDSCALARWAVEC_PRIVATE_C2F \


#define INITIALISE_IDSCALARWAVEC_PRIVATE_C2F \


#define IDSCALARWAVEC_PRIVATE_C2F_PROTO \


#define PASS_IDSCALARWAVEC_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_IDSCALARWAVEC_PROTECTED_FARGUMENTS \


#define IDSCALARWAVEC_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDSCALARWAVEC_PROTECTED_CARGUMENTS \


#define DECLARE_IDSCALARWAVEC_PROTECTED_C2F \


#define INITIALISE_IDSCALARWAVEC_PROTECTED_C2F \


#define IDSCALARWAVEC_PROTECTED_C2F_PROTO \


#define PASS_IDSCALARWAVEC_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_IDSCALARWAVEC_PUBLIC_FARGUMENTS \
...
#define IDSCALARWAVEC_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,phi,phi_p,phi_p_p,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDSCALARWAVEC_PUBLIC_CARGUMENTS \
...
#define DECLARE_IDSCALARWAVEC_PUBLIC_C2F \
...
#define INITIALISE_IDSCALARWAVEC_PUBLIC_C2F \
...
#ifdef FCODE
#define IDSCALARWAVEC_FARGUMENTS _CCTK_FARGUMENTS, IDSCALARWAVEC_PUBLIC_FARGUMENTS

#define DECLARE_IDSCALARWAVEC_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_IDSCALARWAVEC_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IDSCALARWAVEC_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_IDSCALARWAVEC_PUBLIC_CARGUMENTS

#define IDSCALARWAVEC_C2F_PROTO _CCTK_C2F_PROTO, IDSCALARWAVEC_PUBLIC_C2F_PROTO

#define PASS_IDSCALARWAVEC_C2F(GH) _PASS_CCTK_C2F(GH), PASS_IDSCALARWAVEC_PUBLIC_C2F(GH)

#define DECLARE_IDSCALARWAVEC_C2F _DECLARE_CCTK_C2F DECLARE_IDSCALARWAVEC_PUBLIC_C2F

#define INITIALISE_IDSCALARWAVEC_C2F _INITIALISE_CCTK_C2F INITIALISE_IDSCALARWAVEC_PUBLIC_C2F

#define IDSCALARWAVEC_CARGUMENTS cGH *cctkGH
