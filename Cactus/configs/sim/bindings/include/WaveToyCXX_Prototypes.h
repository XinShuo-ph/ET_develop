/*@@
   @header  WaveToyCXX_Prototypes.h
...
#ifndef _WAVETOYCXX_PROTOTYPES_H_
#define _WAVETOYCXX_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_WAVETOYCXX_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
