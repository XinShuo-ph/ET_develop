/*@@
   @header  WaveToyExtra_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn WaveToyExtra
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_WAVETOYEXTRA_PRIVATE_FARGUMENTS \


#define WAVETOYEXTRA_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYEXTRA_PRIVATE_CARGUMENTS \


#define DECLARE_WAVETOYEXTRA_PRIVATE_C2F \


#define INITIALISE_WAVETOYEXTRA_PRIVATE_C2F \


#define WAVETOYEXTRA_PRIVATE_C2F_PROTO \


#define PASS_WAVETOYEXTRA_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_WAVETOYEXTRA_PROTECTED_FARGUMENTS \


#define WAVETOYEXTRA_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYEXTRA_PROTECTED_CARGUMENTS \


#define DECLARE_WAVETOYEXTRA_PROTECTED_C2F \


#define INITIALISE_WAVETOYEXTRA_PROTECTED_C2F \


#define WAVETOYEXTRA_PROTECTED_C2F_PROTO \


#define PASS_WAVETOYEXTRA_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_WAVETOYEXTRA_PUBLIC_FARGUMENTS \
...
#define WAVETOYEXTRA_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,phi,phi_p,phi_p_p,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYEXTRA_PUBLIC_CARGUMENTS \
...
#define DECLARE_WAVETOYEXTRA_PUBLIC_C2F \
...
#define INITIALISE_WAVETOYEXTRA_PUBLIC_C2F \
...
#ifdef FCODE
#define WAVETOYEXTRA_FARGUMENTS _CCTK_FARGUMENTS, WAVETOYEXTRA_PUBLIC_FARGUMENTS

#define DECLARE_WAVETOYEXTRA_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_WAVETOYEXTRA_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYEXTRA_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_WAVETOYEXTRA_PUBLIC_CARGUMENTS

#define WAVETOYEXTRA_C2F_PROTO _CCTK_C2F_PROTO, WAVETOYEXTRA_PUBLIC_C2F_PROTO

#define PASS_WAVETOYEXTRA_C2F(GH) _PASS_CCTK_C2F(GH), PASS_WAVETOYEXTRA_PUBLIC_C2F(GH)

#define DECLARE_WAVETOYEXTRA_C2F _DECLARE_CCTK_C2F DECLARE_WAVETOYEXTRA_PUBLIC_C2F

#define INITIALISE_WAVETOYEXTRA_C2F _INITIALISE_CCTK_C2F INITIALISE_WAVETOYEXTRA_PUBLIC_C2F

#define WAVETOYEXTRA_CARGUMENTS cGH *cctkGH
