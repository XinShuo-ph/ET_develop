...
#include "Meudon_Mag_NS_Arguments.h"
...
#define CCTK_ARGUMENTS MEUDON_MAG_NS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_MEUDON_MAG_NS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS MEUDON_MAG_NS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_MEUDON_MAG_NS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS MEUDON_MAG_NS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_MEUDON_MAG_NS_FARGUMENTS
#define CCTK_CARGUMENTS MEUDON_MAG_NS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_MEUDON_MAG_NS_CARGUMENTS
#endif
