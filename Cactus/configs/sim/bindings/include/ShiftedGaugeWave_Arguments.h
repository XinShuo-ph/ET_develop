/*@@
   @header  ShiftedGaugeWave_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn ShiftedGaugeWave
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_SHIFTEDGAUGEWAVE_PRIVATE_FARGUMENTS \


#define SHIFTEDGAUGEWAVE_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SHIFTEDGAUGEWAVE_PRIVATE_CARGUMENTS \


#define DECLARE_SHIFTEDGAUGEWAVE_PRIVATE_C2F \


#define INITIALISE_SHIFTEDGAUGEWAVE_PRIVATE_C2F \


#define SHIFTEDGAUGEWAVE_PRIVATE_C2F_PROTO \


#define PASS_SHIFTEDGAUGEWAVE_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_SHIFTEDGAUGEWAVE_PROTECTED_FARGUMENTS \


#define SHIFTEDGAUGEWAVE_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SHIFTEDGAUGEWAVE_PROTECTED_CARGUMENTS \


#define DECLARE_SHIFTEDGAUGEWAVE_PROTECTED_C2F \


#define INITIALISE_SHIFTEDGAUGEWAVE_PROTECTED_C2F \


#define SHIFTEDGAUGEWAVE_PROTECTED_C2F_PROTO \


#define PASS_SHIFTEDGAUGEWAVE_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_SHIFTEDGAUGEWAVE_PUBLIC_FARGUMENTS \
...
#define SHIFTEDGAUGEWAVE_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_SHIFTEDGAUGEWAVE_PUBLIC_CARGUMENTS \
...
if (cctki_vi_alpExact == -100) cctki_vi_alpExact = CCTK_VarIndex("ShiftedGaugeWave::alpExact"); \
...
if (cctki_vi_betaExact1 == -100) cctki_vi_betaExact1 = CCTK_VarIndex("ShiftedGaugeWave::betaExact1"); \
...
if (cctki_vi_betaExact2 == -100) cctki_vi_betaExact2 = CCTK_VarIndex("ShiftedGaugeWave::betaExact2"); \
...
if (cctki_vi_betaExact3 == -100) cctki_vi_betaExact3 = CCTK_VarIndex("ShiftedGaugeWave::betaExact3"); \
...
if (cctki_vi_dtalpExact == -100) cctki_vi_dtalpExact = CCTK_VarIndex("ShiftedGaugeWave::dtalpExact"); \
...
if (cctki_vi_dtbetaExact1 == -100) cctki_vi_dtbetaExact1 = CCTK_VarIndex("ShiftedGaugeWave::dtbetaExact1"); \
...
if (cctki_vi_dtbetaExact2 == -100) cctki_vi_dtbetaExact2 = CCTK_VarIndex("ShiftedGaugeWave::dtbetaExact2"); \
...
if (cctki_vi_dtbetaExact3 == -100) cctki_vi_dtbetaExact3 = CCTK_VarIndex("ShiftedGaugeWave::dtbetaExact3"); \
...
if (cctki_vi_gExact11 == -100) cctki_vi_gExact11 = CCTK_VarIndex("ShiftedGaugeWave::gExact11"); \
...
if (cctki_vi_gExact12 == -100) cctki_vi_gExact12 = CCTK_VarIndex("ShiftedGaugeWave::gExact12"); \
...
if (cctki_vi_gExact13 == -100) cctki_vi_gExact13 = CCTK_VarIndex("ShiftedGaugeWave::gExact13"); \
...
if (cctki_vi_gExact22 == -100) cctki_vi_gExact22 = CCTK_VarIndex("ShiftedGaugeWave::gExact22"); \
...
if (cctki_vi_gExact23 == -100) cctki_vi_gExact23 = CCTK_VarIndex("ShiftedGaugeWave::gExact23"); \
...
if (cctki_vi_gExact33 == -100) cctki_vi_gExact33 = CCTK_VarIndex("ShiftedGaugeWave::gExact33"); \
...
if (cctki_vi_kExact11 == -100) cctki_vi_kExact11 = CCTK_VarIndex("ShiftedGaugeWave::kExact11"); \
...
if (cctki_vi_kExact12 == -100) cctki_vi_kExact12 = CCTK_VarIndex("ShiftedGaugeWave::kExact12"); \
...
if (cctki_vi_kExact13 == -100) cctki_vi_kExact13 = CCTK_VarIndex("ShiftedGaugeWave::kExact13"); \
...
if (cctki_vi_kExact22 == -100) cctki_vi_kExact22 = CCTK_VarIndex("ShiftedGaugeWave::kExact22"); \
...
if (cctki_vi_kExact23 == -100) cctki_vi_kExact23 = CCTK_VarIndex("ShiftedGaugeWave::kExact23"); \
...
if (cctki_vi_kExact33 == -100) cctki_vi_kExact33 = CCTK_VarIndex("ShiftedGaugeWave::kExact33"); \
...
#define DECLARE_SHIFTEDGAUGEWAVE_PUBLIC_C2F \
...
#define INITIALISE_SHIFTEDGAUGEWAVE_PUBLIC_C2F \
...
if(CCTKARGNUM_alpExact == -1) CCTKARGNUM_alpExact = CCTK_VarIndex("ShiftedGaugeWave::alpExact"); \
if(CCTKGROUPNUM_lapse_exact == -1) CCTKGROUPNUM_lapse_exact = CCTK_GroupIndex("ShiftedGaugeWave::lapse_exact"); \
if(CCTKARGNUM_betaExact1 == -1) CCTKARGNUM_betaExact1 = CCTK_VarIndex("ShiftedGaugeWave::betaExact1"); \
if(CCTKGROUPNUM_shift_exact == -1) CCTKGROUPNUM_shift_exact = CCTK_GroupIndex("ShiftedGaugeWave::shift_exact"); \
if(CCTKARGNUM_betaExact2 == -1) CCTKARGNUM_betaExact2 = CCTK_VarIndex("ShiftedGaugeWave::betaExact2"); \
if(CCTKARGNUM_betaExact3 == -1) CCTKARGNUM_betaExact3 = CCTK_VarIndex("ShiftedGaugeWave::betaExact3"); \
...
if(CCTKARGNUM_dtalpExact == -1) CCTKARGNUM_dtalpExact = CCTK_VarIndex("ShiftedGaugeWave::dtalpExact"); \
if(CCTKGROUPNUM_dtlapse_exact == -1) CCTKGROUPNUM_dtlapse_exact = CCTK_GroupIndex("ShiftedGaugeWave::dtlapse_exact"); \
if(CCTKARGNUM_dtbetaExact1 == -1) CCTKARGNUM_dtbetaExact1 = CCTK_VarIndex("ShiftedGaugeWave::dtbetaExact1"); \
if(CCTKGROUPNUM_dtshift_exact == -1) CCTKGROUPNUM_dtshift_exact = CCTK_GroupIndex("ShiftedGaugeWave::dtshift_exact"); \
if(CCTKARGNUM_dtbetaExact2 == -1) CCTKARGNUM_dtbetaExact2 = CCTK_VarIndex("ShiftedGaugeWave::dtbetaExact2"); \
if(CCTKARGNUM_dtbetaExact3 == -1) CCTKARGNUM_dtbetaExact3 = CCTK_VarIndex("ShiftedGaugeWave::dtbetaExact3"); \
...
if(CCTKARGNUM_gExact11 == -1) CCTKARGNUM_gExact11 = CCTK_VarIndex("ShiftedGaugeWave::gExact11"); \
if(CCTKGROUPNUM_metric_exact == -1) CCTKGROUPNUM_metric_exact = CCTK_GroupIndex("ShiftedGaugeWave::metric_exact"); \
if(CCTKARGNUM_gExact12 == -1) CCTKARGNUM_gExact12 = CCTK_VarIndex("ShiftedGaugeWave::gExact12"); \
if(CCTKARGNUM_gExact13 == -1) CCTKARGNUM_gExact13 = CCTK_VarIndex("ShiftedGaugeWave::gExact13"); \
if(CCTKARGNUM_gExact22 == -1) CCTKARGNUM_gExact22 = CCTK_VarIndex("ShiftedGaugeWave::gExact22"); \
if(CCTKARGNUM_gExact23 == -1) CCTKARGNUM_gExact23 = CCTK_VarIndex("ShiftedGaugeWave::gExact23"); \
if(CCTKARGNUM_gExact33 == -1) CCTKARGNUM_gExact33 = CCTK_VarIndex("ShiftedGaugeWave::gExact33"); \
...
if(CCTKARGNUM_kExact11 == -1) CCTKARGNUM_kExact11 = CCTK_VarIndex("ShiftedGaugeWave::kExact11"); \
if(CCTKGROUPNUM_curv_exact == -1) CCTKGROUPNUM_curv_exact = CCTK_GroupIndex("ShiftedGaugeWave::curv_exact"); \
if(CCTKARGNUM_kExact12 == -1) CCTKARGNUM_kExact12 = CCTK_VarIndex("ShiftedGaugeWave::kExact12"); \
if(CCTKARGNUM_kExact13 == -1) CCTKARGNUM_kExact13 = CCTK_VarIndex("ShiftedGaugeWave::kExact13"); \
if(CCTKARGNUM_kExact22 == -1) CCTKARGNUM_kExact22 = CCTK_VarIndex("ShiftedGaugeWave::kExact22"); \
if(CCTKARGNUM_kExact23 == -1) CCTKARGNUM_kExact23 = CCTK_VarIndex("ShiftedGaugeWave::kExact23"); \
if(CCTKARGNUM_kExact33 == -1) CCTKARGNUM_kExact33 = CCTK_VarIndex("ShiftedGaugeWave::kExact33"); \
...
#define SHIFTEDGAUGEWAVE_PUBLIC_C2F_PROTO \
...
#define PASS_SHIFTEDGAUGEWAVE_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define SHIFTEDGAUGEWAVE_FARGUMENTS _CCTK_FARGUMENTS, SHIFTEDGAUGEWAVE_PUBLIC_FARGUMENTS

#define DECLARE_SHIFTEDGAUGEWAVE_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_SHIFTEDGAUGEWAVE_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SHIFTEDGAUGEWAVE_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_SHIFTEDGAUGEWAVE_PUBLIC_CARGUMENTS

#define SHIFTEDGAUGEWAVE_C2F_PROTO _CCTK_C2F_PROTO, SHIFTEDGAUGEWAVE_PUBLIC_C2F_PROTO

#define PASS_SHIFTEDGAUGEWAVE_C2F(GH) _PASS_CCTK_C2F(GH), PASS_SHIFTEDGAUGEWAVE_PUBLIC_C2F(GH)

#define DECLARE_SHIFTEDGAUGEWAVE_C2F _DECLARE_CCTK_C2F DECLARE_SHIFTEDGAUGEWAVE_PUBLIC_C2F

#define INITIALISE_SHIFTEDGAUGEWAVE_C2F _INITIALISE_CCTK_C2F INITIALISE_SHIFTEDGAUGEWAVE_PUBLIC_C2F

#define SHIFTEDGAUGEWAVE_CARGUMENTS cGH *cctkGH
