/*@@
   @header  Meudon_Bin_NS_Prototypes.h
...
#ifndef _MEUDON_BIN_NS_PROTOTYPES_H_
#define _MEUDON_BIN_NS_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_MEUDON_BIN_NS_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
