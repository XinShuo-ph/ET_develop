...
#define CCTK_ARGUMENTS MPI_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_MPI_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS MPI_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_MPI_FARGUMENTS
#endif

#define CCTK_FARGUMENTS MPI_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_MPI_FARGUMENTS
#define CCTK_CARGUMENTS MPI_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_MPI_CARGUMENTS
#endif
