...
#define CCTK_ARGUMENTS TESTTYPES_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTTYPES_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTTYPES_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTTYPES_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTTYPES_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTTYPES_FARGUMENTS
#define CCTK_CARGUMENTS TESTTYPES_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTTYPES_CARGUMENTS
#endif
