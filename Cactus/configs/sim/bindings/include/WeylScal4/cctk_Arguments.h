...
#define CCTK_ARGUMENTS WEYLSCAL4_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WEYLSCAL4_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS WEYLSCAL4_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WEYLSCAL4_FARGUMENTS
#endif

#define CCTK_FARGUMENTS WEYLSCAL4_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_WEYLSCAL4_FARGUMENTS
#define CCTK_CARGUMENTS WEYLSCAL4_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_WEYLSCAL4_CARGUMENTS
#endif
