...
#define CCTK_ARGUMENTS HTTPD_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HTTPD_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS HTTPD_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_HTTPD_FARGUMENTS
#endif

#define CCTK_FARGUMENTS HTTPD_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_HTTPD_FARGUMENTS
#define CCTK_CARGUMENTS HTTPD_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_HTTPD_CARGUMENTS
#endif
