...
#ifndef _IOJPEG_PROTOTYPES_H_
#define _IOJPEG_PROTOTYPES_H_  1
...
CCTK_INT Hyperslab_GlobalMappingByIndex(const CCTK_POINTER_TO_CONST cctkGH ,
 ...
 const CCTK_POINTER_TO_CONST src ,
 const CCTK_POINTER dst) ,
 CCTK_INT* hsize);
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_IOJPEG_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
