/*@@
   @header  WaveToyCXX_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn WaveToyCXX
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_WAVETOYCXX_PRIVATE_FARGUMENTS \


#define WAVETOYCXX_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYCXX_PRIVATE_CARGUMENTS \


#define DECLARE_WAVETOYCXX_PRIVATE_C2F \


#define INITIALISE_WAVETOYCXX_PRIVATE_C2F \


#define WAVETOYCXX_PRIVATE_C2F_PROTO \


#define PASS_WAVETOYCXX_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_WAVETOYCXX_PROTECTED_FARGUMENTS \


#define WAVETOYCXX_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYCXX_PROTECTED_CARGUMENTS \


#define DECLARE_WAVETOYCXX_PROTECTED_C2F \


#define INITIALISE_WAVETOYCXX_PROTECTED_C2F \


#define WAVETOYCXX_PROTECTED_C2F_PROTO \


#define PASS_WAVETOYCXX_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_WAVETOYCXX_PUBLIC_FARGUMENTS \
...
#define WAVETOYCXX_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,phi,phi_p,phi_p_p,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYCXX_PUBLIC_CARGUMENTS \
...
#define DECLARE_WAVETOYCXX_PUBLIC_C2F \
...
#define INITIALISE_WAVETOYCXX_PUBLIC_C2F \
...
#ifdef FCODE
#define WAVETOYCXX_FARGUMENTS _CCTK_FARGUMENTS, WAVETOYCXX_PUBLIC_FARGUMENTS

#define DECLARE_WAVETOYCXX_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_WAVETOYCXX_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVETOYCXX_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_WAVETOYCXX_PUBLIC_CARGUMENTS

#define WAVETOYCXX_C2F_PROTO _CCTK_C2F_PROTO, WAVETOYCXX_PUBLIC_C2F_PROTO

#define PASS_WAVETOYCXX_C2F(GH) _PASS_CCTK_C2F(GH), PASS_WAVETOYCXX_PUBLIC_C2F(GH)

#define DECLARE_WAVETOYCXX_C2F _DECLARE_CCTK_C2F DECLARE_WAVETOYCXX_PUBLIC_C2F

#define INITIALISE_WAVETOYCXX_C2F _INITIALISE_CCTK_C2F INITIALISE_WAVETOYCXX_PUBLIC_C2F

#define WAVETOYCXX_CARGUMENTS cGH *cctkGH
