...
#include "SampleBoundary_Arguments.h"
...
#define CCTK_ARGUMENTS SAMPLEBOUNDARY_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SAMPLEBOUNDARY_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SAMPLEBOUNDARY_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SAMPLEBOUNDARY_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SAMPLEBOUNDARY_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SAMPLEBOUNDARY_FARGUMENTS
#define CCTK_CARGUMENTS SAMPLEBOUNDARY_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SAMPLEBOUNDARY_CARGUMENTS
#endif
