...
#define CCTK_ARGUMENTS LIBJPEG_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_LIBJPEG_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS LIBJPEG_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_LIBJPEG_FARGUMENTS
#endif

#define CCTK_FARGUMENTS LIBJPEG_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_LIBJPEG_FARGUMENTS
#define CCTK_CARGUMENTS LIBJPEG_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_LIBJPEG_CARGUMENTS
#endif
