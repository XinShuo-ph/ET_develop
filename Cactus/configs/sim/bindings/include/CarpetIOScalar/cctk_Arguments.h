...
#include "CarpetIOScalar_Arguments.h"
...
#define CCTK_ARGUMENTS CARPETIOSCALAR_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETIOSCALAR_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETIOSCALAR_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETIOSCALAR_FARGUMENTS
#endif

#define CCTK_FARGUMENTS CARPETIOSCALAR_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_CARPETIOSCALAR_FARGUMENTS
#define CCTK_CARGUMENTS CARPETIOSCALAR_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_CARPETIOSCALAR_CARGUMENTS
#endif
