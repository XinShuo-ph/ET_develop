/*@@
   @header  ReflectionSymmetry_Prototypes.h
...
#ifndef _REFLECTIONSYMMETRY_PROTOTYPES_H_
#define _REFLECTIONSYMMETRY_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_REFLECTIONSYMMETRY_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
