/*@@
   @header  PeriodicCarpet_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn PeriodicCarpet
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_PERIODICCARPET_PRIVATE_FARGUMENTS \


#define PERIODICCARPET_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_PERIODICCARPET_PRIVATE_CARGUMENTS \


#define DECLARE_PERIODICCARPET_PRIVATE_C2F \


#define INITIALISE_PERIODICCARPET_PRIVATE_C2F \


#define PERIODICCARPET_PRIVATE_C2F_PROTO \


#define PASS_PERIODICCARPET_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_PERIODICCARPET_PROTECTED_FARGUMENTS \


#define PERIODICCARPET_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_PERIODICCARPET_PROTECTED_CARGUMENTS \


#define DECLARE_PERIODICCARPET_PROTECTED_C2F \


#define INITIALISE_PERIODICCARPET_PROTECTED_C2F \


#define PERIODICCARPET_PROTECTED_C2F_PROTO \


#define PASS_PERIODICCARPET_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_PERIODICCARPET_PUBLIC_FARGUMENTS \
...
#define PERIODICCARPET_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_PERIODICCARPET_PUBLIC_CARGUMENTS \
...
#define DECLARE_PERIODICCARPET_PUBLIC_C2F \
...
#define INITIALISE_PERIODICCARPET_PUBLIC_C2F \
...
#define PERIODICCARPET_PUBLIC_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_PERIODICCARPET_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define PERIODICCARPET_FARGUMENTS _CCTK_FARGUMENTS, PERIODICCARPET_PUBLIC_FARGUMENTS

#define DECLARE_PERIODICCARPET_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_PERIODICCARPET_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_PERIODICCARPET_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_PERIODICCARPET_PUBLIC_CARGUMENTS

#define PERIODICCARPET_C2F_PROTO _CCTK_C2F_PROTO, PERIODICCARPET_PUBLIC_C2F_PROTO

#define PASS_PERIODICCARPET_C2F(GH) _PASS_CCTK_C2F(GH), PASS_PERIODICCARPET_PUBLIC_C2F(GH)

#define DECLARE_PERIODICCARPET_C2F _DECLARE_CCTK_C2F DECLARE_PERIODICCARPET_PUBLIC_C2F

#define INITIALISE_PERIODICCARPET_C2F _INITIALISE_CCTK_C2F INITIALISE_PERIODICCARPET_PUBLIC_C2F

#define PERIODICCARPET_CARGUMENTS cGH *cctkGH
