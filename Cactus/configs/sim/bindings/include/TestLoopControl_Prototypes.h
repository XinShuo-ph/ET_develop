/*@@
   @header  TestLoopControl_Prototypes.h
...
#ifndef _TESTLOOPCONTROL_PROTOTYPES_H_
#define _TESTLOOPCONTROL_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_TESTLOOPCONTROL_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
