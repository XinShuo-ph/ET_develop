...
extern struct
{
  ...
  const char * out_group_separator;
  const char * out_mode;
...
#define DECLARE_RESTRICTED_IO_STRUCT_PARAMS \
  ...
  CCTK_DECLARE_INIT (const char * const, out_group_separator, CCTK_PARAMETER__IO__out_group_separator); \
...
#endif
#ifndef CCTK_PARAMETER__IO__out_group_separator
