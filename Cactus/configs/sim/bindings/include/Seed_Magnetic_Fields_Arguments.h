/*@@
   @header  Seed_Magnetic_Fields_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn Seed_Magnetic_Fields
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_SEED_MAGNETIC_FIELDS_PRIVATE_FARGUMENTS \


#define SEED_MAGNETIC_FIELDS_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SEED_MAGNETIC_FIELDS_PRIVATE_CARGUMENTS \


#define DECLARE_SEED_MAGNETIC_FIELDS_PRIVATE_C2F \


#define INITIALISE_SEED_MAGNETIC_FIELDS_PRIVATE_C2F \


#define SEED_MAGNETIC_FIELDS_PRIVATE_C2F_PROTO \


#define PASS_SEED_MAGNETIC_FIELDS_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_SEED_MAGNETIC_FIELDS_PROTECTED_FARGUMENTS \


#define SEED_MAGNETIC_FIELDS_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SEED_MAGNETIC_FIELDS_PROTECTED_CARGUMENTS \


#define DECLARE_SEED_MAGNETIC_FIELDS_PROTECTED_C2F \


#define INITIALISE_SEED_MAGNETIC_FIELDS_PROTECTED_C2F \


#define SEED_MAGNETIC_FIELDS_PROTECTED_C2F_PROTO \


#define PASS_SEED_MAGNETIC_FIELDS_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_SEED_MAGNETIC_FIELDS_PUBLIC_FARGUMENTS \
INTEGER Avec_length&&\
INTEGER Bvec_length&&\
INTEGER vel_length&&\
...
#define SEED_MAGNETIC_FIELDS_PUBLIC_FARGUMENTS \
Avec_length,Bvec_length,vel_length,Abar,Abar_p,Abar_p_p,Aphi,Aphi_p,Aphi_p_p,Avec,Avec_p,Avec_p_p,Bvec,Bvec_p,Bvec_p_p,Y_e,Y_e_p,Y_e_p_p,alp,alp_p,alp_p_p,betax,betax_p,betax_p_p,betay,betay_p,betay_p_p,betaz,betaz_p,betaz_p_p,coarse_dx,coarse_dy,coarse_dz,dtalp,dtalp_p,dtalp_p_p,dtbetax,dtbetax_p,dtbetax_p_p,dtbetay,dtbetay_p,dtbetay_p_p,dtbetaz,dtbetaz_p,dtbetaz_p_p,dtlapse_state,dtshift_state,entropy,entropy_p,entropy_p_p,eps,eps_p,eps_p_p,gxx,gxx_p,gxx_p_p,gxy,gxy_p,gxy_p_p,gxz,gxz_p,gxz_p_p,gyy,gyy_p,gyy_p_p,gyz,gyz_p,gyz_p_p,gzz,gzz_p,gzz_p_p,hydro_excision_mask,kxx,kxx_p,kxx_p_p,kxy,kxy_p,kxy_p_p,kxz,kxz_p,kxz_p_p,kyy,kyy_p,kyy_p_p,kyz,kyz_p,kyz_p_p,kzz,kzz_p,kzz_p_p,press,press_p,press_p_p,r,rho,rho_p,rho_p_p,shift_state,temperature,temperature_p,temperature_p_p,vel,vel_p,vel_p_p,w_lorentz,w_lorentz_p,w_lorentz_p_p,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SEED_MAGNETIC_FIELDS_PUBLIC_CARGUMENTS \
...
#define DECLARE_SEED_MAGNETIC_FIELDS_PUBLIC_C2F \
...
#define INITIALISE_SEED_MAGNETIC_FIELDS_PUBLIC_C2F \
...
#define SEED_MAGNETIC_FIELDS_PUBLIC_C2F_PROTO \
...
#define PASS_SEED_MAGNETIC_FIELDS_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define SEED_MAGNETIC_FIELDS_FARGUMENTS _CCTK_FARGUMENTS, SEED_MAGNETIC_FIELDS_PUBLIC_FARGUMENTS

#define DECLARE_SEED_MAGNETIC_FIELDS_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_SEED_MAGNETIC_FIELDS_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SEED_MAGNETIC_FIELDS_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_SEED_MAGNETIC_FIELDS_PUBLIC_CARGUMENTS

#define SEED_MAGNETIC_FIELDS_C2F_PROTO _CCTK_C2F_PROTO, SEED_MAGNETIC_FIELDS_PUBLIC_C2F_PROTO

#define PASS_SEED_MAGNETIC_FIELDS_C2F(GH) _PASS_CCTK_C2F(GH), PASS_SEED_MAGNETIC_FIELDS_PUBLIC_C2F(GH)

#define DECLARE_SEED_MAGNETIC_FIELDS_C2F _DECLARE_CCTK_C2F DECLARE_SEED_MAGNETIC_FIELDS_PUBLIC_C2F

#define INITIALISE_SEED_MAGNETIC_FIELDS_C2F _INITIALISE_CCTK_C2F INITIALISE_SEED_MAGNETIC_FIELDS_PUBLIC_C2F

#define SEED_MAGNETIC_FIELDS_CARGUMENTS cGH *cctkGH
