...
#include "PeriodicCarpet_Arguments.h"
...
#define CCTK_ARGUMENTS PERIODICCARPET_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PERIODICCARPET_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS PERIODICCARPET_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PERIODICCARPET_FARGUMENTS
#endif

#define CCTK_FARGUMENTS PERIODICCARPET_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_PERIODICCARPET_FARGUMENTS
#define CCTK_CARGUMENTS PERIODICCARPET_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_PERIODICCARPET_CARGUMENTS
#endif
