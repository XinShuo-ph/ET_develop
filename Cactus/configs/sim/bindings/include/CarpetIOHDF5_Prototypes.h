...
CCTK_INT CarpetIOHDF5_SetCheckpointGroups(const CCTK_INT* groups ,
 const CCTK_INT ngroups);
...
#define DECLARE_CARPETIOHDF5_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  ...
  interface &&\
     CCTK_INT function IO_SetCheckpointGroups (groups, ngroups) &&\
       implicit none &&\
       CCTK_INT groups(*) &&\
       CCTK_INT ngroups &&\
     end function IO_SetCheckpointGroups &&\
  end interface &&\
  interface &&\
...
#define DECLARE_CARPETIOHDF5_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  ...
  external IO_SetCheckpointGroups &&\
  CCTK_INT IO_SetCheckpointGroups &&\
