...
#include "SystemStatistics_Arguments.h"
...
#define CCTK_ARGUMENTS SYSTEMSTATISTICS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SYSTEMSTATISTICS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SYSTEMSTATISTICS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SYSTEMSTATISTICS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SYSTEMSTATISTICS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SYSTEMSTATISTICS_FARGUMENTS
#define CCTK_CARGUMENTS SYSTEMSTATISTICS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SYSTEMSTATISTICS_CARGUMENTS
#endif
