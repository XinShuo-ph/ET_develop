...
#define CCTK_ARGUMENTS CARPETINTERP_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETINTERP_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETINTERP_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETINTERP_FARGUMENTS
#endif
