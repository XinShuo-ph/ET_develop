...
#define CCTK_ARGUMENTS TGRTENSOR_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TGRTENSOR_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TGRTENSOR_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TGRTENSOR_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TGRTENSOR_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TGRTENSOR_FARGUMENTS
#define CCTK_CARGUMENTS TGRTENSOR_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TGRTENSOR_CARGUMENTS
#endif
