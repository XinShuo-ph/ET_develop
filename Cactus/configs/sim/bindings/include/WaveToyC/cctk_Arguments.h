...
#define CCTK_ARGUMENTS WAVETOYC_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WAVETOYC_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS WAVETOYC_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_WAVETOYC_FARGUMENTS
#endif

#define CCTK_FARGUMENTS WAVETOYC_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_WAVETOYC_FARGUMENTS
#define CCTK_CARGUMENTS WAVETOYC_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_WAVETOYC_CARGUMENTS
#endif
