...
#include "SystemTopology_Arguments.h"
...
#define CCTK_ARGUMENTS SYSTEMTOPOLOGY_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SYSTEMTOPOLOGY_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SYSTEMTOPOLOGY_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SYSTEMTOPOLOGY_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SYSTEMTOPOLOGY_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SYSTEMTOPOLOGY_FARGUMENTS
#define CCTK_CARGUMENTS SYSTEMTOPOLOGY_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SYSTEMTOPOLOGY_CARGUMENTS
#endif
