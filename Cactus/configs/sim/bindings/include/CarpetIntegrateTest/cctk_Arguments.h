...
#define CCTK_ARGUMENTS CARPETINTEGRATETEST_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETINTEGRATETEST_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETINTEGRATETEST_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETINTEGRATETEST_FARGUMENTS
#endif
