...
#define CCTK_ARGUMENTS NULLGRID_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NULLGRID_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NULLGRID_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NULLGRID_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NULLGRID_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NULLGRID_FARGUMENTS
#define CCTK_CARGUMENTS NULLGRID_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NULLGRID_CARGUMENTS
#endif
