...
#define CCTK_ARGUMENTS NORMS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NORMS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NORMS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NORMS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NORMS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NORMS_FARGUMENTS
#define CCTK_CARGUMENTS NORMS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NORMS_CARGUMENTS
#endif
