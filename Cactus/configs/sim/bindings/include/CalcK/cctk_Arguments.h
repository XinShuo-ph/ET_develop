...
#define CCTK_ARGUMENTS CALCK_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CALCK_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CALCK_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CALCK_FARGUMENTS
#endif

#define CCTK_FARGUMENTS CALCK_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_CALCK_FARGUMENTS
#define CCTK_CARGUMENTS CALCK_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_CALCK_CARGUMENTS
#endif
