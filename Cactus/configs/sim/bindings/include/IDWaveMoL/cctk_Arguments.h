...
#define CCTK_ARGUMENTS IDWAVEMOL_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDWAVEMOL_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS IDWAVEMOL_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDWAVEMOL_FARGUMENTS
#endif
