...
#define CCTK_ARGUMENTS NULLNEWS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NULLNEWS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS NULLNEWS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_NULLNEWS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS NULLNEWS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_NULLNEWS_FARGUMENTS
#define CCTK_CARGUMENTS NULLNEWS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_NULLNEWS_CARGUMENTS
#endif
