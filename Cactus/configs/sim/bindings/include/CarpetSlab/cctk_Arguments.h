...
#define CCTK_ARGUMENTS CARPETSLAB_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETSLAB_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CARPETSLAB_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CARPETSLAB_FARGUMENTS
#endif
