...
#define CCTK_ARGUMENTS PERIODIC_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PERIODIC_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS PERIODIC_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PERIODIC_FARGUMENTS
#endif

#define CCTK_FARGUMENTS PERIODIC_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_PERIODIC_FARGUMENTS
#define CCTK_CARGUMENTS PERIODIC_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_PERIODIC_CARGUMENTS
#endif
