...
#define CCTK_ARGUMENTS GSL_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_GSL_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS GSL_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_GSL_FARGUMENTS
#endif
