...
#include "QuasiLocalMeasures_Arguments.h"
...
#define CCTK_ARGUMENTS QUASILOCALMEASURES_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_QUASILOCALMEASURES_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS QUASILOCALMEASURES_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_QUASILOCALMEASURES_FARGUMENTS
#endif

#define CCTK_FARGUMENTS QUASILOCALMEASURES_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_QUASILOCALMEASURES_FARGUMENTS
#define CCTK_CARGUMENTS QUASILOCALMEASURES_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_QUASILOCALMEASURES_CARGUMENTS
#endif
