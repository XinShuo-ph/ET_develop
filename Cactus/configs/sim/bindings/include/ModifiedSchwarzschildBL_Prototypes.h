/*@@
   @header  ModifiedSchwarzschildBL_Prototypes.h
...
#ifndef _MODIFIEDSCHWARZSCHILDBL_PROTOTYPES_H_
#define _MODIFIEDSCHWARZSCHILDBL_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_MODIFIEDSCHWARZSCHILDBL_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
