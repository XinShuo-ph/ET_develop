...
#define CCTK_ARGUMENTS OPENSSL_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_OPENSSL_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS OPENSSL_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_OPENSSL_FARGUMENTS
#endif

#define CCTK_FARGUMENTS OPENSSL_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_OPENSSL_FARGUMENTS
#define CCTK_CARGUMENTS OPENSSL_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_OPENSSL_CARGUMENTS
#endif
