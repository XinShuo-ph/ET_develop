...
#define CCTK_ARGUMENTS OUTFLOW_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_OUTFLOW_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS OUTFLOW_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_OUTFLOW_FARGUMENTS
#endif

#define CCTK_FARGUMENTS OUTFLOW_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_OUTFLOW_FARGUMENTS
#define CCTK_CARGUMENTS OUTFLOW_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_OUTFLOW_CARGUMENTS
#endif
