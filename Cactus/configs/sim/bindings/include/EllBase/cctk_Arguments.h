...
#define CCTK_ARGUMENTS ELLBASE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ELLBASE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ELLBASE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ELLBASE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ELLBASE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ELLBASE_FARGUMENTS
#define CCTK_CARGUMENTS ELLBASE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ELLBASE_CARGUMENTS
#endif
