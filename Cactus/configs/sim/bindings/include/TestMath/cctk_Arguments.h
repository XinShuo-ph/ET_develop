...
#define CCTK_ARGUMENTS TESTMATH_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTMATH_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTMATH_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTMATH_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTMATH_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTMATH_FARGUMENTS
#define CCTK_CARGUMENTS TESTMATH_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTMATH_CARGUMENTS
#endif
