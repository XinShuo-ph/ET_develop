...
#define CCTK_ARGUMENTS PTHREADS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PTHREADS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS PTHREADS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_PTHREADS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS PTHREADS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_PTHREADS_FARGUMENTS
#define CCTK_CARGUMENTS PTHREADS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_PTHREADS_CARGUMENTS
#endif
