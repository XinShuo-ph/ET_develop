...
#define CCTK_ARGUMENTS ML_CCZ4_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ML_CCZ4_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ML_CCZ4_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ML_CCZ4_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ML_CCZ4_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ML_CCZ4_FARGUMENTS
#define CCTK_CARGUMENTS ML_CCZ4_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ML_CCZ4_CARGUMENTS
#endif
