...
CCTK_DECLARE(CCTK_REAL,GammaShift,)&&\
...
CCTK_DECLARE(CCTK_REAL,dampk1,)&&\
CCTK_DECLARE(CCTK_REAL,dampk2,)&&\
...
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ADMBaseBoundaryScalar_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ADMBaseBoundaryScalar_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ADMBaseEverywhere_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ADMBaseEverywhere_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ADMBaseInterior_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ADMBaseInterior_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ConstraintsEverywhere_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ConstraintsEverywhere_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ConstraintsInterior_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_ConstraintsInterior_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EnforceEverywhere_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EnforceEverywhere_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionAnalysisInit_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionAnalysisInit_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionAnalysisInterior_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionAnalysisInterior_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionBoundaryScalar_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionBoundaryScalar_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionInteriorSplitBy1_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionInteriorSplitBy1_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionInteriorSplitBy2_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionInteriorSplitBy2_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionInteriorSplitBy3_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionInteriorSplitBy3_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionInterior_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_EvolutionInterior_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_InitialADMBase1Everywhere_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_InitialADMBase1Everywhere_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_InitialADMBase2BoundaryScalar_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_InitialADMBase2BoundaryScalar_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_InitialADMBase2Interior_calc_every,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_InitialADMBase2Interior_calc_offset,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_MaxNumArrayEvolvedVars,)&&\
CCTK_DECLARE(CCTK_INT,ML_CCZ4_MaxNumEvolvedVars,)&&\
...
COMMON /ML_CCZ4rest/GammaShift, LapseACoeff, LapseAdvectionCoeff, ShiftAdvectionCoeff, ShiftBCoeff, alphaDriver, betaDriver, dampk1, dampk2, epsDiss, harmonicF, minimumLapse, shiftAlphaPower, shiftGammaCoeff, spatialBetaDriverRadius, spatialShiftGammaCoeffRadius, apply_dissipation, initial_boundary_condition, my_boundary_condition, my_initial_boundary_condition, my_initial_data, my_rhs_boundary_condition, rhs_boundary_condition, rhs_evaluation, ML_CCZ4_ADMBaseBoundaryScalar_calc_every, ML_CCZ4_ADMBaseBoundaryScalar_calc_offset, ML_CCZ4_ADMBaseEverywhere_calc_every, ML_CCZ4_ADMBaseEverywhere_calc_offset, ML_CCZ4_ADMBaseInterior_calc_every, ML_CCZ4_ADMBaseInterior_calc_offset, ML_CCZ4_ConstraintsEverywhere_calc_every, ML_CCZ4_ConstraintsEverywhere_calc_offset, ML_CCZ4_ConstraintsInterior_calc_every, ML_CCZ4_ConstraintsInterior_calc_offset, ML_CCZ4_EnforceEverywhere_calc_every, ML_CCZ4_EnforceEverywhere_calc_offset, ML_CCZ4_EvolutionAnalysisInit_calc_every, ML_CCZ4_EvolutionAnalysisInit_calc_offset, ML_CCZ4_EvolutionAnalysisInterior_calc_every, ML_CCZ4_EvolutionAnalysisInterior_calc_offset, ML_CCZ4_EvolutionBoundaryScalar_calc_every, ML_CCZ4_EvolutionBoundaryScalar_calc_offset, ML_CCZ4_EvolutionInteriorSplitBy1_calc_every, ML_CCZ4_EvolutionInteriorSplitBy1_calc_offset, ML_CCZ4_EvolutionInteriorSplitBy2_calc_every, ML_CCZ4_EvolutionInteriorSplitBy2_calc_offset, ML_CCZ4_EvolutionInteriorSplitBy3_calc_every, ML_CCZ4_EvolutionInteriorSplitBy3_calc_offset, ML_CCZ4_EvolutionInterior_calc_every, ML_CCZ4_EvolutionInterior_calc_offset, ML_CCZ4_InitialADMBase1Everywhere_calc_every, ML_CCZ4_InitialADMBase1Everywhere_calc_offset, ML_CCZ4_InitialADMBase2BoundaryScalar_calc_every, ML_CCZ4_InitialADMBase2BoundaryScalar_calc_offset, ML_CCZ4_InitialADMBase2Interior_calc_every, ML_CCZ4_InitialADMBase2Interior_calc_offset, ML_CCZ4_MaxNumArrayEvolvedVars, ML_CCZ4_MaxNumEvolvedVars, advectLapse, advectShift, conformalMethod, evolveA, evolveB, fdOrder, fixAdvectionTerms, harmonicN, other_timelevels, rhs_timelevels, shiftFormulation, tile_size, timelevels, useSpatialBetaDriver, useSpatialShiftGammaCoeff, verbose&&\
...
CCTK_DECLARE(CCTK_REAL,ML_Theta_bound_limit,)&&\
CCTK_DECLARE(CCTK_REAL,ML_Theta_bound_scalar,)&&\
CCTK_DECLARE(CCTK_REAL,ML_Theta_bound_speed,)&&\
...
CCTK_DECLARE(CCTK_REAL,Theta_bound_limit,)&&\
CCTK_DECLARE(CCTK_REAL,Theta_bound_scalar,)&&\
CCTK_DECLARE(CCTK_REAL,Theta_bound_speed,)&&\
...
CCTK_DECLARE(CCTK_STRING,ML_Theta_bound,)&&\
...
CCTK_DECLARE(CCTK_STRING,Theta_bound,)&&\
...
COMMON /ML_CCZ4priv/A_bound_limit, A_bound_scalar, A_bound_speed, At11_bound_limit, At11_bound_scalar, At11_bound_speed, At12_bound_limit, At12_bound_scalar, At12_bound_speed, At13_bound_limit, At13_bound_scalar, At13_bound_speed, At22_bound_limit, At22_bound_scalar, At22_bound_speed, At23_bound_limit, At23_bound_scalar, At23_bound_speed, At33_bound_limit, At33_bound_scalar, At33_bound_speed, B1_bound_limit, B1_bound_scalar, B1_bound_speed, B2_bound_limit, B2_bound_scalar, B2_bound_speed, B3_bound_limit, B3_bound_scalar, B3_bound_speed, ML_Gamma_bound_limit, ML_Gamma_bound_scalar, ML_Gamma_bound_speed, ML_Theta_bound_limit, ML_Theta_bound_scalar, ML_Theta_bound_speed, ML_curv_bound_limit, ML_curv_bound_scalar, ML_curv_bound_speed, ML_dtlapse_bound_limit, ML_dtlapse_bound_scalar, ML_dtlapse_bound_speed, ML_dtshift_bound_limit, ML_dtshift_bound_scalar, ML_dtshift_bound_speed, ML_lapse_bound_limit, ML_lapse_bound_scalar, ML_lapse_bound_speed, ML_log_confac_bound_limit, ML_log_confac_bound_scalar, ML_log_confac_bound_speed, ML_metric_bound_limit, ML_metric_bound_scalar, ML_metric_bound_speed, ML_shift_bound_limit, ML_shift_bound_scalar, ML_shift_bound_speed, ML_trace_curv_bound_limit, ML_trace_curv_bound_scalar, ML_trace_curv_bound_speed, Theta_bound_limit, Theta_bound_scalar, Theta_bound_speed, Xt1_bound_limit, Xt1_bound_scalar, Xt1_bound_speed, Xt2_bound_limit, Xt2_bound_scalar, Xt2_bound_speed, Xt3_bound_limit, Xt3_bound_scalar, Xt3_bound_speed, alpha_bound_limit, alpha_bound_scalar, alpha_bound_speed, beta1_bound_limit, beta1_bound_scalar, beta1_bound_speed, beta2_bound_limit, beta2_bound_scalar, beta2_bound_speed, beta3_bound_limit, beta3_bound_scalar, beta3_bound_speed, gt11_bound_limit, gt11_bound_scalar, gt11_bound_speed, gt12_bound_limit, gt12_bound_scalar, gt12_bound_speed, gt13_bound_limit, gt13_bound_scalar, gt13_bound_speed, gt22_bound_limit, gt22_bound_scalar, gt22_bound_speed, gt23_bound_limit, gt23_bound_scalar, gt23_bound_speed, gt33_bound_limit, gt33_bound_scalar, gt33_bound_speed, phi_bound_limit, phi_bound_scalar, phi_bound_speed, trK_bound_limit, trK_bound_scalar, trK_bound_speed, A_bound, At11_bound, At12_bound, At13_bound, At22_bound, At23_bound, At33_bound, B1_bound, B2_bound, B3_bound, ML_Gamma_bound, ML_Theta_bound, ML_curv_bound, ML_dtlapse_bound, ML_dtshift_bound, ML_lapse_bound, ML_log_confac_bound, ML_metric_bound, ML_shift_bound, ML_trace_curv_bound, Theta_bound, Xt1_bound, Xt2_bound, Xt3_bound, alpha_bound, beta1_bound, beta2_bound, beta3_bound, dt_lapse_shift_method, gt11_bound, gt12_bound, gt13_bound, gt22_bound, gt23_bound, gt33_bound, phi_bound, trK_bound&&\
