...
#define CCTK_ARGUMENTS FLESHINFO_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_FLESHINFO_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS FLESHINFO_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_FLESHINFO_FARGUMENTS
#endif

#define CCTK_FARGUMENTS FLESHINFO_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_FLESHINFO_FARGUMENTS
#define CCTK_CARGUMENTS FLESHINFO_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_FLESHINFO_CARGUMENTS
#endif
