...
#include "TestLocalReduce_Arguments.h"
...
#define CCTK_ARGUMENTS TESTLOCALREDUCE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTLOCALREDUCE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTLOCALREDUCE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTLOCALREDUCE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTLOCALREDUCE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTLOCALREDUCE_FARGUMENTS
#define CCTK_CARGUMENTS TESTLOCALREDUCE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTLOCALREDUCE_CARGUMENTS
#endif
