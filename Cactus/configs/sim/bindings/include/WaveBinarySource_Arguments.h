/*@@
   @header  WaveBinarySource_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn WaveBinarySource
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_WAVEBINARYSOURCE_PRIVATE_FARGUMENTS \


#define WAVEBINARYSOURCE_PRIVATE_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVEBINARYSOURCE_PRIVATE_CARGUMENTS \


#define DECLARE_WAVEBINARYSOURCE_PRIVATE_C2F \


#define INITIALISE_WAVEBINARYSOURCE_PRIVATE_C2F \


#define WAVEBINARYSOURCE_PRIVATE_C2F_PROTO \


#define PASS_WAVEBINARYSOURCE_PRIVATE_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_WAVEBINARYSOURCE_PROTECTED_FARGUMENTS \


#define WAVEBINARYSOURCE_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVEBINARYSOURCE_PROTECTED_CARGUMENTS \


#define DECLARE_WAVEBINARYSOURCE_PROTECTED_C2F \


#define INITIALISE_WAVEBINARYSOURCE_PROTECTED_C2F \


#define WAVEBINARYSOURCE_PROTECTED_C2F_PROTO \


#define PASS_WAVEBINARYSOURCE_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_WAVEBINARYSOURCE_PUBLIC_FARGUMENTS \
...
#define WAVEBINARYSOURCE_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,phi,phi_p,phi_p_p,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVEBINARYSOURCE_PUBLIC_CARGUMENTS \
...
#define DECLARE_WAVEBINARYSOURCE_PUBLIC_C2F \
...
#define INITIALISE_WAVEBINARYSOURCE_PUBLIC_C2F \
...
#ifdef FCODE
#define WAVEBINARYSOURCE_FARGUMENTS _CCTK_FARGUMENTS, WAVEBINARYSOURCE_PUBLIC_FARGUMENTS

#define DECLARE_WAVEBINARYSOURCE_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_WAVEBINARYSOURCE_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_WAVEBINARYSOURCE_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_WAVEBINARYSOURCE_PUBLIC_CARGUMENTS

#define WAVEBINARYSOURCE_C2F_PROTO _CCTK_C2F_PROTO, WAVEBINARYSOURCE_PUBLIC_C2F_PROTO

#define PASS_WAVEBINARYSOURCE_C2F(GH) _PASS_CCTK_C2F(GH), PASS_WAVEBINARYSOURCE_PUBLIC_C2F(GH)

#define DECLARE_WAVEBINARYSOURCE_C2F _DECLARE_CCTK_C2F DECLARE_WAVEBINARYSOURCE_PUBLIC_C2F

#define INITIALISE_WAVEBINARYSOURCE_C2F _INITIALISE_CCTK_C2F INITIALISE_WAVEBINARYSOURCE_PUBLIC_C2F

#define WAVEBINARYSOURCE_CARGUMENTS cGH *cctkGH
