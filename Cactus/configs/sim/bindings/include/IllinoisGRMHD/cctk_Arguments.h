...
#include "IllinoisGRMHD_Arguments.h"
...
#define CCTK_ARGUMENTS ILLINOISGRMHD_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ILLINOISGRMHD_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ILLINOISGRMHD_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ILLINOISGRMHD_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ILLINOISGRMHD_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ILLINOISGRMHD_FARGUMENTS
#define CCTK_CARGUMENTS ILLINOISGRMHD_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ILLINOISGRMHD_CARGUMENTS
#endif
