...
#define CCTK_ARGUMENTS TOVSOLVER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TOVSOLVER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TOVSOLVER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TOVSOLVER_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TOVSOLVER_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TOVSOLVER_FARGUMENTS
#define CCTK_CARGUMENTS TOVSOLVER_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TOVSOLVER_CARGUMENTS
#endif
