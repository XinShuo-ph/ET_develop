...
#define CCTK_ARGUMENTS TESTPAR_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTPAR_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTPAR_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTPAR_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTPAR_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTPAR_FARGUMENTS
#define CCTK_CARGUMENTS TESTPAR_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTPAR_CARGUMENTS
#endif
