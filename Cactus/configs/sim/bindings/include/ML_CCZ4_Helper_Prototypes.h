/*@@
   @header  ML_CCZ4_Helper_Prototypes.h
...
#ifndef _ML_CCZ4_HELPER_PROTOTYPES_H_
#define _ML_CCZ4_HELPER_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_ML_CCZ4_HELPER_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
