...
#define CCTK_ARGUMENTS CONSTANTS_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CONSTANTS_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CONSTANTS_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CONSTANTS_FARGUMENTS
#endif

#define CCTK_FARGUMENTS CONSTANTS_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_CONSTANTS_FARGUMENTS
#define CCTK_CARGUMENTS CONSTANTS_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_CONSTANTS_CARGUMENTS
#endif
