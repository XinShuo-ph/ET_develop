...
#include "CT_MultiLevel_Arguments.h"
...
#define CCTK_ARGUMENTS CT_MULTILEVEL_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CT_MULTILEVEL_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS CT_MULTILEVEL_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_CT_MULTILEVEL_FARGUMENTS
#endif

#define CCTK_FARGUMENTS CT_MULTILEVEL_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_CT_MULTILEVEL_FARGUMENTS
#define CCTK_CARGUMENTS CT_MULTILEVEL_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_CT_MULTILEVEL_CARGUMENTS
#endif
