...
#define CCTK_ARGUMENTS SOCKET_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SOCKET_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS SOCKET_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_SOCKET_FARGUMENTS
#endif

#define CCTK_FARGUMENTS SOCKET_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_SOCKET_FARGUMENTS
#define CCTK_CARGUMENTS SOCKET_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_SOCKET_CARGUMENTS
#endif
