...
#include "IDScalarWaveElliptic_Arguments.h"
...
#define CCTK_ARGUMENTS IDSCALARWAVEELLIPTIC_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDSCALARWAVEELLIPTIC_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS IDSCALARWAVEELLIPTIC_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDSCALARWAVEELLIPTIC_FARGUMENTS
#endif

#define CCTK_FARGUMENTS IDSCALARWAVEELLIPTIC_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_IDSCALARWAVEELLIPTIC_FARGUMENTS
#define CCTK_CARGUMENTS IDSCALARWAVEELLIPTIC_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_IDSCALARWAVEELLIPTIC_CARGUMENTS
#endif
