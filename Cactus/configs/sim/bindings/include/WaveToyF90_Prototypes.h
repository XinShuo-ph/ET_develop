/*@@
   @header  WaveToyF90_Prototypes.h
...
#ifndef _WAVETOYF90_PROTOTYPES_H_
#define _WAVETOYF90_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_WAVETOYF90_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
