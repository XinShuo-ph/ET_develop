/*@@
   @header  Poisson_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn Poisson
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_POISSON_PRIVATE_FARGUMENTS \
CCTK_DECLARE(CCTK_REAL,phi,(cctk_ash1,cctk_ash2,cctk_ash3))&&\
CCTK_DECLARE(CCTK_REAL,res,(cctk_ash1,cctk_ash2,cctk_ash3))&&\


#define POISSON_PRIVATE_FARGUMENTS \
phi,res

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_POISSON_PRIVATE_CARGUMENTS \
static int cctki_vi_phi = -100; \
if (cctki_vi_phi == -100) cctki_vi_phi = CCTK_VarIndex("Poisson::phi"); \
...
if (cctki_vi_res == -100) cctki_vi_res = CCTK_VarIndex("Poisson::res"); \
CCTK_DECLARE_INIT (CCTK_REAL * restrict const, res, (CCTK_REAL *) CCTKi_VarDataPtrI(cctkGH, 0, cctki_vi_res));

#define DECLARE_POISSON_PRIVATE_C2F \
static int CCTKARGNUM_phi = -1; \
static int CCTKGROUPNUM_potential = -1; \
static int CCTKARGNUM_res = -1; \
static int CCTKGROUPNUM_residual = -1;

#define INITIALISE_POISSON_PRIVATE_C2F \
if(CCTKARGNUM_phi == -1) CCTKARGNUM_phi = CCTK_VarIndex("Poisson::phi"); \
if(CCTKGROUPNUM_potential == -1) CCTKGROUPNUM_potential = CCTK_GroupIndex("Poisson::potential"); \
if(CCTKARGNUM_res == -1) CCTKARGNUM_res = CCTK_VarIndex("Poisson::res"); \
if(CCTKGROUPNUM_residual == -1) CCTKGROUPNUM_residual = CCTK_GroupIndex("Poisson::residual");

#define POISSON_PRIVATE_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *

#define PASS_POISSON_PRIVATE_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_POISSON_PROTECTED_FARGUMENTS \


#define POISSON_PROTECTED_FARGUMENTS \


#endif /* FCODE */

#ifdef CCODE
#define DECLARE_POISSON_PROTECTED_CARGUMENTS \


#define DECLARE_POISSON_PROTECTED_C2F \


#define INITIALISE_POISSON_PROTECTED_C2F \


#define POISSON_PROTECTED_C2F_PROTO \


#define PASS_POISSON_PROTECTED_C2F(GH) \


#endif /* CCODE */

#ifdef FCODE
#define DECLARE_POISSON_PUBLIC_FARGUMENTS \
...
#define POISSON_PUBLIC_FARGUMENTS \
coarse_dx,coarse_dy,coarse_dz,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_POISSON_PUBLIC_CARGUMENTS \
...
#define DECLARE_POISSON_PUBLIC_C2F \
...
#define INITIALISE_POISSON_PUBLIC_C2F \
...
#ifdef FCODE
#define POISSON_FARGUMENTS _CCTK_FARGUMENTS, POISSON_PRIVATE_FARGUMENTS, POISSON_PUBLIC_FARGUMENTS

#define DECLARE_POISSON_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_POISSON_PRIVATE_FARGUMENTS DECLARE_POISSON_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_POISSON_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_POISSON_PRIVATE_CARGUMENTS DECLARE_POISSON_PUBLIC_CARGUMENTS

#define POISSON_C2F_PROTO _CCTK_C2F_PROTO, POISSON_PRIVATE_C2F_PROTO, POISSON_PUBLIC_C2F_PROTO

#define PASS_POISSON_C2F(GH) _PASS_CCTK_C2F(GH), PASS_POISSON_PRIVATE_C2F(GH), PASS_POISSON_PUBLIC_C2F(GH)

#define DECLARE_POISSON_C2F _DECLARE_CCTK_C2F DECLARE_POISSON_PRIVATE_C2F DECLARE_POISSON_PUBLIC_C2F

#define INITIALISE_POISSON_C2F _INITIALISE_CCTK_C2F INITIALISE_POISSON_PRIVATE_C2F INITIALISE_POISSON_PUBLIC_C2F

#define POISSON_CARGUMENTS cGH *cctkGH
