/*@@
   @header  ML_WaveToy_Prototypes.h
...
#ifndef _ML_WAVETOY_PROTOTYPES_H_
#define _ML_WAVETOY_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_ML_WAVETOY_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
