...
#define CCTK_ARGUMENTS EOS_BASE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EOS_BASE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS EOS_BASE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_EOS_BASE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS EOS_BASE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_EOS_BASE_FARGUMENTS
#define CCTK_CARGUMENTS EOS_BASE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_EOS_BASE_CARGUMENTS
#endif
