...
#define CCTK_ARGUMENTS TESTTABLE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTTABLE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS TESTTABLE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_TESTTABLE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS TESTTABLE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_TESTTABLE_FARGUMENTS
#define CCTK_CARGUMENTS TESTTABLE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_TESTTABLE_CARGUMENTS
#endif
