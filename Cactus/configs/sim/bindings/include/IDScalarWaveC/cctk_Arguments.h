...
#include "IDScalarWaveC_Arguments.h"
...
#define CCTK_ARGUMENTS IDSCALARWAVEC_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDSCALARWAVEC_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS IDSCALARWAVEC_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_IDSCALARWAVEC_FARGUMENTS
#endif

#define CCTK_FARGUMENTS IDSCALARWAVEC_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_IDSCALARWAVEC_FARGUMENTS
#define CCTK_CARGUMENTS IDSCALARWAVEC_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_IDSCALARWAVEC_CARGUMENTS
#endif
