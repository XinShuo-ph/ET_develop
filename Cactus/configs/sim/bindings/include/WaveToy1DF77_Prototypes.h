/*@@
   @header  WaveToy1DF77_Prototypes.h
...
#ifndef _WAVETOY1DF77_PROTOTYPES_H_
#define _WAVETOY1DF77_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_WAVETOY1DF77_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
